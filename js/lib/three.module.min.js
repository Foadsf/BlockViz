...
import {
    ...
    Euler as u,
    Matrix4 as f,
    ColorManagement as p,
    SRGBTransfer as m,
    PlaneGeometry as h,
    FrontSide as _,
    getUnlitUniformColorSpace as g,
    IntType as v,
    HalfFloatType as E,
    ...
    RGBAFormat as M,
    Plane as x,
    EquirectangularReflectionMapping as R,
    EquirectangularRefractionMapping as A,
    WebGLCubeRenderTarget as b,
    CubeReflectionMapping as C,
    CubeRefractionMapping as L,
    OrthographicCamera as P,
    PerspectiveCamera as U,
    NoToneMapping as D,
    MeshBasicMaterial as w,
    NoBlending as y,
    WebGLRenderTarget as I,
    BufferGeometry as N,
    BufferAttribute as O,
    LinearSRGBColorSpace as F,
    LinearFilter as B,
    warnOnce as H,
    Uint32BufferAttribute as G,
    Uint16BufferAttribute as V,
    arrayNeedsUint32 as z,
    Vector4 as k,
    DataArrayTexture as W,
    CubeTexture as X,
    Data3DTexture as Y,
    LessEqualCompare as K,
    DepthTexture as j,
    Texture as q,
    GLSL3 as Z,
    PCFShadowMap as $,
    ...
    VSMShadowMap as J,
    CustomToneMapping as ee,
    NeutralToneMapping as te,
    AgXToneMapping as ne,
    ACESFilmicToneMapping as re,
    CineonToneMapping as ie,
    ReinhardToneMapping as ae,
    LinearToneMapping as oe,
    LinearTransfer as se,
    AddOperation as le,
    MixOperation as ce,
    MultiplyOperation as de,
    UniformsUtils as ue,
    DoubleSide as fe,
    NormalBlending as pe,
    TangentSpaceNormalMap as me,
    ObjectSpaceNormalMap as he,
    Layers as _e,
    Frustum as ge,
    MeshDepthMaterial as ve,
    RGBADepthPacking as Ee,
    MeshDistanceMaterial as Se,
    NearestFilter as Te,
    LessEqualDepth as Me,
    ReverseSubtractEquation as xe,
    SubtractEquation as Re,
    AddEquation as Ae,
    OneMinusConstantAlphaFactor as be,
    ConstantAlphaFactor as Ce,
    OneMinusConstantColorFactor as Le,
    ConstantColorFactor as Pe,
    OneMinusDstAlphaFactor as Ue,
    OneMinusDstColorFactor as De,
    OneMinusSrcAlphaFactor as we,
    OneMinusSrcColorFactor as ye,
    DstAlphaFactor as Ie,
    DstColorFactor as Ne,
    SrcAlphaSaturateFactor as Oe,
    SrcAlphaFactor as Fe,
    SrcColorFactor as Be,
    OneFactor as He,
    ZeroFactor as Ge,
    NotEqualDepth as Ve,
    GreaterDepth as ze,
    GreaterEqualDepth as ke,
    EqualDepth as We,
    LessDepth as Xe,
    AlwaysDepth as Ye,
    NeverDepth as Ke,
    ...
    CullFaceFront as Ze,
    CustomBlending as $e,
    MultiplyBlending as Qe,
    SubtractiveBlending as Je,
    AdditiveBlending as et,
    MinEquation as tt,
    MaxEquation as nt,
    MirroredRepeatWrapping as rt,
    ClampToEdgeWrapping as it,
    RepeatWrapping as at,
    LinearMipmapLinearFilter as ot,
    LinearMipmapNearestFilter as st,
    NearestMipmapLinearFilter as lt,
    NearestMipmapNearestFilter as ct,
    NotEqualCompare as dt,
    GreaterCompare as ut,
    GreaterEqualCompare as ft,
    EqualCompare as pt,
    LessCompare as mt,
    AlwaysCompare as ht,
    NeverCompare as _t,
    NoColorSpace as gt,
    DepthStencilFormat as vt,
    getByteLength as Et,
    DepthFormat as St,
    UnsignedIntType as Tt,
    UnsignedInt248Type as Mt,
    UnsignedShortType as xt,
    createElementNS as Rt,
    UnsignedShort4444Type as At,
    UnsignedShort5551Type as bt,
    UnsignedInt5999Type as Ct,
    ByteType as Lt,
    ShortType as Pt,
    AlphaFormat as Ut,
    RGBFormat as Dt,
    RedFormat as wt,
    RedIntegerFormat as yt,
    RGFormat as It,
    RGIntegerFormat as Nt,
    RGBAIntegerFormat as Ot,
    RGB_S3TC_DXT1_Format as Ft,
    RGBA_S3TC_DXT1_Format as Bt,
    RGBA_S3TC_DXT3_Format as Ht,
    RGBA_S3TC_DXT5_Format as Gt,
    RGB_PVRTC_4BPPV1_Format as Vt,
    RGB_PVRTC_2BPPV1_Format as zt,
    RGBA_PVRTC_4BPPV1_Format as kt,
    RGBA_PVRTC_2BPPV1_Format as Wt,
    RGB_ETC1_Format as Xt,
    RGB_ETC2_Format as Yt,
    RGBA_ETC2_EAC_Format as Kt,
    RGBA_ASTC_4x4_Format as jt,
    RGBA_ASTC_5x4_Format as qt,
    RGBA_ASTC_5x5_Format as Zt,
    RGBA_ASTC_6x5_Format as $t,
    RGBA_ASTC_6x6_Format as Qt,
    RGBA_ASTC_8x5_Format as Jt,
    RGBA_ASTC_8x6_Format as en,
    RGBA_ASTC_8x8_Format as tn,
    RGBA_ASTC_10x5_Format as nn,
    RGBA_ASTC_10x6_Format as rn,
    RGBA_ASTC_10x8_Format as an,
    RGBA_ASTC_10x10_Format as on,
    RGBA_ASTC_12x10_Format as sn,
    RGBA_ASTC_12x12_Format as ln,
    RGBA_BPTC_Format as cn,
    RGB_BPTC_SIGNED_Format as dn,
    RGB_BPTC_UNSIGNED_Format as un,
    RED_RGTC1_Format as fn,
    SIGNED_RED_RGTC1_Format as pn,
    RED_GREEN_RGTC2_Format as mn,
    SIGNED_RED_GREEN_RGTC2_Format as hn,
    EventDispatcher as _n,
    ArrayCamera as gn,
    WebXRController as vn,
    RAD2DEG as En,
    createCanvasElement as Sn,
    SRGBColorSpace as Tn,
    REVISION as Mn,
    toNormalizedProjectionMatrix as xn,
    toReversedProjectionMatrix as Rn,
    probeAsync as An,
    WebGLCoordinateSystem as bn,
...
const Pn = {
    ...
    Un = {
        ...
        specularmap: { specularMap: { value: null }, specularMapTransform: { value: new e() } },
        envmap: {
            envMap: { value: null },
        ...
        emissivemap: { emissiveMap: { value: null }, emissiveMapTransform: { value: new e() } },
        metalnessmap: { metalnessMap: { value: null }, metalnessMapTransform: { value: new e() } },
        roughnessmap: { roughnessMap: { value: null }, roughnessMapTransform: { value: new e() } },
    ...
    Dn = {
        basic: {
            uniforms: r([Un.common, Un.specularmap, Un.envmap, Un.aomap, Un.lightmap, Un.fog]),
        ...
        depth: {
            uniforms: r([Un.common, Un.displacementmap]),
        ...
        shadow: {
            uniforms: r([Un.lights, Un.fog, { color: { value: new n(0) }, opacity: { value: 1 } }]),
...
Dn.physical = {
    uniforms: r([
        Dn.standard.uniforms,
        {
            ...
            clearcoatNormalScale: { value: new t(1, 1) },
...
function Nn(e, t, r, i, u, f, v) {
    ...
    function b(e) {
        ...
        if (n && n.isTexture) {
            n = (e.backgroundBlurriness > 0 ? r : t).get(n);
        }
        return n;
    }
    function C(t, n) {
        t.getRGB(wn, g(e)), i.buffers.color.setClear(wn.r, wn.g, wn.b, n, v);
    }
    return {
        ...
        render: function (t) {
            let n = !1;
            const r = b(t);
            null === r ? C(E, M) : r && r.isColor && (C(r, 1), (n = !0));
            const a = e.xr.getEnvironmentBlendMode();
            'additive' === a
                ? i.buffers.color.setClear(0, 0, 0, 1, v)
                : 'alpha-blend' === a && i.buffers.color.setClear(0, 0, 0, 0, v),
                (e.autoClear || n) &&
        ...
        addToRenderList: function (t, n) {
            const r = b(n);
            r && (r.isCubeTexture || r.mapping === a)
                ? (void 0 === T &&
                      ((T = new o(
                          new s(1, 1, 1),
                          new l({
                              name: 'BackgroundCubeMaterial',
                              uniforms: d(Dn.backgroundCube.uniforms),
                      ...
                      T.geometry.deleteAttribute('uv'),
                      (T.onBeforeRender = function (e, t, n) {
                      ...
                      u.update(T)),
                  yn.copy(n.backgroundRotation),
                  (yn.x *= -1),
                  (yn.y *= -1),
                  (yn.z *= -1),
                  r.isCubeTexture && !1 === r.isRenderTargetTexture && ((yn.y *= -1), (yn.z *= -1)),
                  (T.material.uniforms.envMap.value = r),
                  (T.material.uniforms.flipEnvMap.value =
                      r.isCubeTexture && !1 === r.isRenderTargetTexture ? -1 : 1),
                  (T.material.uniforms.backgroundBlurriness.value = n.backgroundBlurriness),
                  (T.material.uniforms.backgroundIntensity.value = n.backgroundIntensity),
                  T.material.uniforms.backgroundRotation.value.setFromMatrix4(
                      In.makeRotationFromEuler(yn)
                  ),
                  (T.material.toneMapped = p.getTransfer(r.colorSpace) !== m),
                  (x === r && R === r.version && A === e.toneMapping) ||
                      ((T.material.needsUpdate = !0),
                      (x = r),
                      (R = r.version),
                      (A = e.toneMapping)),
                  T.layers.enableAll(),
                  t.unshift(T, T.geometry, T.material, 0, 0, null))
                : r &&
                  r.isTexture &&
                  (void 0 === S &&
                      ((S = new o(
                          ...
                          new l({
                              ...
                              uniforms: d(Dn.background.uniforms),
                  ...
                  (S.material.toneMapped = p.getTransfer(r.colorSpace) !== m),
        ...
        dispose: function () {
            void 0 !== T && (T.geometry.dispose(), T.material.dispose(), (T = void 0)),
...
function On(e, t) {
    ...
    function h() {
        _(), (o = !0), a !== i && ((a = i), s(a.object));
    }
    function _() {
        (i.geometry = null), (i.program = null), (i.wireframe = !1);
    }
    return {
        setup: function (n, i, l, h, _) {
            let g = !1;
            const E = (function (t, n, i) {
                ...
                void 0 === s && ((s = {}), (o[n.id] = s));
                let l = s[a];
                void 0 === l && ((l = c(e.createVertexArray())), (s[a] = l));
                return l;
            })(h, l, i);
            a !== E && ((a = E), s(a.object)),
                (g = (function (e, t, n, r) {
                ...
                (g || o) &&
                            ...
                            if (i.location >= 0) {
                                ...
                                if (
                                    ...
                                    const c = l.buffer,
                                        d = l.type,
                                        p = l.bytesPerElement,
                                        h = d === e.INT || d === e.UNSIGNED_INT || s.gpuType === v;
                                    if (s.isInterleavedBufferAttribute) {
                                        ...
                                        if (t.isInstancedInterleavedBuffer) {
                                            for (let e = 0; e < i.locationSize; e++)
                                                f(i.location + e, t.meshPerAttribute);
                                            !0 !== n.isInstancedMesh &&
                    ...
                    null !== _ && e.bindBuffer(e.ELEMENT_ARRAY_BUFFER, t.get(_).buffer));
        },
        reset: h,
        resetDefaultState: _,
        dispose: function () {
...
function Bn(e, t, n, r) {
    ...
    return {
        ...
        textureFormatReadable: function (t) {
            return t === M || r.convert(t) === e.getParameter(e.IMPLEMENTATION_COLOR_READ_FORMAT);
        },
...
function Hn(t) {
    ...
    function d(e, t, r, i) {
        ...
        if (0 !== a) {
            if (((o = c.value), !0 !== i || null === o)) {
                const n = r + 4 * a,
                    i = t.matrixWorldInverse;
                l.getNormalMatrix(i), (null === o || o.length < n) && (o = new Float32Array(n));
    ...
    (this.uniform = c),
        ...
        (this.init = function (e, t) {
            const n = 0 !== e.length || t || 0 !== i || a;
            return (a = t), (i = e.length), n;
        }),
        ...
        (this.setState = function (e, s, l) {
            const u = e.clippingPlanes,
                f = e.clipIntersection,
                p = e.clipShadows,
                m = t.get(e);
            if (!a || null === u || 0 === u.length || (o && !p))
                o
                    ? d(null)
                    : (function () {
                          c.value !== r && ((c.value = r), (c.needsUpdate = i > 0));
                          (n.numPlanes = i), (n.numIntersection = 0);
                      })();
            else {
                const e = o ? 0 : i,
                    t = 4 * e;
                let n = m.clippingState || null;
                (c.value = n), (n = d(u, s, t, l));
...
function Gn(e) {
    let t = new WeakMap();
    function n(e, t) {
        return t === R ? (e.mapping = C) : t === A && (e.mapping = L), e;
    }
    function r(e) {
        const n = e.target;
...
const Vn = [0.125, 0.215, 0.35, 0.446, 0.526, 0.582],
    zn = 20,
    kn = new P(),
    Wn = new n();
let Xn = null,
...
class Jn {
    ...
    fromScene(e, t = 0, n = 0.1, r = 100, i = {}) {
        const { size: a = 256, position: o = Qn } = i;
        (Xn = this._renderer.getRenderTarget()),
            (Yn = this._renderer.getActiveCubeFace()),
            (Kn = this._renderer.getActiveMipmapLevel()),
            (jn = this._renderer.xr.enabled),
    ...
    compileCubemapShader() {
        null === this._cubemapMaterial &&
            ((this._cubemapMaterial = rr()), this._compileMaterial(this._cubemapMaterial));
    }
    ...
    _cleanup(e) {
        this._renderer.setRenderTarget(Xn, Yn, Kn),
            (this._renderer.xr.enabled = jn),
            (e.scissorTest = !1),
            tr(e, 0, 0, e.width, e.height);
    }
    _fromTexture(e, t) {
        e.mapping === C || e.mapping === L
    ...
    _allocateTargets() {
        ...
        if (
            ...
            null !== this._pingPongRenderTarget && this._dispose(),
                (this._pingPongRenderTarget = er(e, t, n));
            ...
            ({
                ...
                const t = [],
                    ...
                    r = [];
                let i = e;
                const a = e - 4 + 1 + Vn.length;
                for (let o = 0; o < a; o++) {
                    const a = Math.pow(2, i);
                    n.push(a);
                    let s = 1 / a;
                    o > e - 4 ? (s = Vn[o - e + 4 - 1]) : 0 === o && (s = 0), r.push(s);
                    const l = 1 / (a - 2),
                        c = -l,
                        d = 1 + l,
                        u = [c, c, d, c, d, d, c, c, d, d, c, d],
                        f = 6,
                        p = 6,
                        m = 3,
                        h = 2,
                        _ = 1,
                        g = new Float32Array(m * p * f),
                        v = new Float32Array(h * p * f),
                        E = new Float32Array(_ * p * f);
                    for (let e = 0; e < f; e++) {
                        const t = ((e % 3) * 2) / 3 - 1,
                            n = e > 2 ? 0 : -1,
                            r = [
                        ...
                        g.set(r, m * p * e), v.set(u, h * p * e);
                        const i = [e, e, e, e, e, e];
                        E.set(i, _ * p * e);
                    }
                    const S = new N();
                    S.setAttribute('position', new O(g, m)),
                        S.setAttribute('uv', new O(v, h)),
                        S.setAttribute('faceIndex', new O(E, _)),
                        t.push(S),
                        i > 4 && i--;
                }
    ...
    _compileMaterial(e) {
        const t = new o(this._lodPlanes[0], e);
        this._renderer.compile(t, kn);
    }
    _sceneToCubeUV(e, t, n, r, i) {
        const a = new U(90, 1, t, n),
            l = [1, -1, 1, 1, 1, 1],
            d = [1, 1, 1, -1, -1, -1],
            u = this._renderer,
            f = u.autoClear,
            p = u.toneMapping;
        u.getClearColor(Wn), (u.toneMapping = D), (u.autoClear = !1);
        const m = new w({ name: 'PMREM.Background', side: c, depthWrite: !1, depthTest: !1 }),
            h = new o(new s(), m);
        let _ = !1;
        const g = e.background;
        g
            ? g.isColor && (m.color.copy(g), (e.background = null), (_ = !0))
            : (m.color.copy(Wn), (_ = !0));
        for (let t = 0; t < 6; t++) {
            const n = t % 3;
            0 === n
                ? (a.up.set(0, l[t], 0),
                  ...
                  a.lookAt(i.x + d[t], i.y, i.z))
                : 1 === n
                ? (a.up.set(0, 0, l[t]),
                  a.position.set(i.x, i.y, i.z),
                  a.lookAt(i.x, i.y + d[t], i.z))
                : (a.up.set(0, l[t], 0),
                  a.position.set(i.x, i.y, i.z),
                  a.lookAt(i.x, i.y, i.z + d[t]));
            const o = this._cubeSize;
            tr(r, n * o, t > 2 ? o : 0, o, o),
                u.setRenderTarget(r),
                _ && u.render(h, a),
                u.render(e, a);
        }
    ...
    _textureToCubeUV(e, t) {
        ...
        const i = r ? this._cubemapMaterial : this._equirectMaterial,
            a = new o(this._lodPlanes[0], i);
        i.uniforms.envMap.value = e;
        const s = this._cubeSize;
        tr(t, 0, 0, 3 * s, 2 * s), n.setRenderTarget(t), n.render(a, kn);
    }
    _applyPMREM(e) {
    ...
    _halfBlur(e, t, n, r, i, a, s) {
        ...
        const d = new o(this._lodPlanes[r], c),
            u = c.uniforms,
            f = this._sizeLods[n] - 1,
            p = isFinite(i) ? Math.PI / (2 * f) : (2 * Math.PI) / 39,
            m = i / p,
            h = isFinite(i) ? 1 + Math.floor(3 * m) : zn;
        h > zn &&
            console.warn(
                `sigmaRadians, ${i}, is too large and will clip, as it requested ${h} samples when the maximum is set to 20`
            );
        const _ = [];
        let g = 0;
        for (let e = 0; e < zn; ++e) {
        ...
        tr(t, 3 * E * (r > v - 4 ? r - v + 4 : 0), 4 * (this._cubeSize - E), 3 * E, 2 * E),
            l.setRenderTarget(t),
            l.render(d, kn);
    }
}
function er(e, t, n) {
    const r = new I(e, t, n);
    return (r.texture.mapping = a), (r.texture.name = 'PMREM.cubeUv'), (r.scissorTest = !0), r;
}
...
function or(e) {
    ...
    return {
        ...
        get: function (e) {
            const t = n(e);
            return null === t && H('THREE.WebGLRenderer: ' + e + ' extension not supported.'), t;
        },
    };
}
function sr(e, t, n, r) {
...
function lr(e, t, n) {
    ...
    (this.setMode = function (e) {
        ...
        (this.renderMultiDrawInstances = function (e, s, l, c) {
            ...
            if (null === d) for (let t = 0; t < e.length; t++) o(e[t] / a, s[t], c[t]);
            else {
                d.multiDrawElementsInstancedWEBGL(r, s, 0, i, e, 0, c, 0, l);
                let t = 0;
                for (let e = 0; e < l; e++) t += s[e] * c[e];
                n.update(t, r, 1);
            }
        });
}
    ...
    return {
        update: function (o, s, l) {
            ...
            if (void 0 === f || f.count !== u) {
                ...
                const p = void 0 !== s.morphAttributes.position,
                    m = void 0 !== s.morphAttributes.normal,
                    h = void 0 !== s.morphAttributes.color,
                    _ = s.morphAttributes.position || [],
                    g = s.morphAttributes.normal || [],
                    v = s.morphAttributes.color || [];
                let E = 0;
                !0 === p && (E = 1), !0 === m && (E = 2), !0 === h && (E = 3);
                let S = s.attributes.position.count * E,
                    M = 1;
                S > n.maxTextureSize &&
                    ((M = Math.ceil(S / n.maxTextureSize)), (S = n.maxTextureSize));
                const x = new Float32Array(S * M * 4 * u),
                    R = new W(x, S, M, u);
                (R.type = T), (R.needsUpdate = !0);
                const A = 4 * E;
                for (let C = 0; C < u; C++) {
                    const L = _[C],
                        P = g[C],
                    ...
                    for (let w = 0; w < L.count; w++) {
                        ...
                        !0 === p &&
                            ...
                            (x[D + y + 3] = 0)),
                            !0 === m &&
                                (a.fromBufferAttribute(P, w),
                                (x[D + y + 4] = a.x),
                                (x[D + y + 5] = a.y),
                                (x[D + y + 6] = a.z),
                                (x[D + y + 7] = 0)),
                            !0 === h &&
                                (a.fromBufferAttribute(U, w),
                                (x[D + y + 8] = a.x),
                                (x[D + y + 9] = a.y),
                                (x[D + y + 10] = a.z),
                                (x[D + y + 11] = 4 === U.itemSize ? a.w : 1));
                    }
                }
                function b() {
                    R.dispose(), i.delete(s), s.removeEventListener('dispose', b);
                }
                (f = { count: u, texture: R, size: new t(S, M) }),
                    i.set(s, f),
                    s.addEventListener('dispose', b);
            }
            if (!0 === o.isInstancedMesh && null !== o.morphTexture)
                l.getUniforms().setValue(e, 'morphTexture', o.morphTexture, r);
            else {
                let I = 0;
            ...
            l.getUniforms().setValue(e, 'morphTargetsTexture', f.texture, r),
                l.getUniforms().setValue(e, 'morphTargetsTextureSize', f.size);
        },
    };
}
function ur(e, t, n, r) {
...
function Mr(e, t, n) {
    ...
    const i = t * n;
    let a = gr[i];
    if ((void 0 === a && ((a = new Float32Array(i)), (gr[i] = a)), 0 !== t)) {
        r.toArray(a, 0);
...
function Ar(e, t) {
    let n = vr[t];
    void 0 === n && ((n = new Int32Array(t)), (vr[t] = n));
...
function Cr(e, t) {
    ...
    if (void 0 !== t.x)
        ...
        if (xr(n, t)) return;
        e.uniform2fv(this.addr, t), Rr(n, t);
    }
}
function Lr(e, t) {
    const n = this.cache;
    if (void 0 !== t.x)
        ...
        if (xr(n, t)) return;
        e.uniform3fv(this.addr, t), Rr(n, t);
    }
}
function Pr(e, t) {
    const n = this.cache;
    if (void 0 !== t.x)
        ...
        if (xr(n, t)) return;
        e.uniform4fv(this.addr, t), Rr(n, t);
    }
}
function Ur(e, t) {
    const n = this.cache,
    ...
    if (void 0 === r) {
        if (xr(n, t)) return;
        e.uniformMatrix2fv(this.addr, !1, t), Rr(n, t);
    } else {
        if (xr(n, r)) return;
        Tr.set(r), e.uniformMatrix2fv(this.addr, !1, Tr), Rr(n, r);
    }
}
function Dr(e, t) {
    const n = this.cache,
    ...
    if (void 0 === r) {
        if (xr(n, t)) return;
        e.uniformMatrix3fv(this.addr, !1, t), Rr(n, t);
    } else {
        if (xr(n, r)) return;
        Sr.set(r), e.uniformMatrix3fv(this.addr, !1, Sr), Rr(n, r);
    }
}
function wr(e, t) {
    const n = this.cache,
    ...
    if (void 0 === r) {
        if (xr(n, t)) return;
        e.uniformMatrix4fv(this.addr, !1, t), Rr(n, t);
    } else {
        if (xr(n, r)) return;
        Er.set(r), e.uniformMatrix4fv(this.addr, !1, Er), Rr(n, r);
    }
}
function yr(e, t) {
    const n = this.cache;
...
function Vr(e, t, n) {
    ...
    r[0] !== i && (e.uniform1i(this.addr, i), (r[0] = i)),
        this.type === e.SAMPLER_2D_SHADOW ? ((pr.compareFunction = K), (a = pr)) : (a = fr),
        n.setTexture2D(t || a, i);
}
function zr(e, t, n) {
    const r = this.cache,
        i = n.allocateTextureUnit();
    r[0] !== i && (e.uniform1i(this.addr, i), (r[0] = i)), n.setTexture3D(t || hr, i);
}
function kr(e, t, n) {
    const r = this.cache,
        i = n.allocateTextureUnit();
    r[0] !== i && (e.uniform1i(this.addr, i), (r[0] = i)), n.setTextureCube(t || _r, i);
}
function Wr(e, t, n) {
    const r = this.cache,
        i = n.allocateTextureUnit();
    r[0] !== i && (e.uniform1i(this.addr, i), (r[0] = i)), n.setTexture2DArray(t || mr, i);
}
function Xr(e, t) {
    e.uniform1fv(this.addr, t);
}
function Yr(e, t) {
    const n = Mr(t, this.size, 2);
    e.uniform2fv(this.addr, n);
}
function Kr(e, t) {
    const n = Mr(t, this.size, 3);
    e.uniform3fv(this.addr, n);
}
function jr(e, t) {
    const n = Mr(t, this.size, 4);
...
function Zr(e, t) {
    const n = Mr(t, this.size, 9);
    e.uniformMatrix3fv(this.addr, !1, n);
}
function $r(e, t) {
    const n = Mr(t, this.size, 16);
...
function oi(e, t, n) {
    const r = this.cache,
        i = t.length,
        a = Ar(n, i);
    xr(r, a) || (e.uniform1iv(this.addr, a), Rr(r, a));
    for (let e = 0; e !== i; ++e) n.setTexture2D(t[e] || fr, a[e]);
}
function si(e, t, n) {
    const r = this.cache,
        i = t.length,
        a = Ar(n, i);
    xr(r, a) || (e.uniform1iv(this.addr, a), Rr(r, a));
    for (let e = 0; e !== i; ++e) n.setTexture3D(t[e] || hr, a[e]);
}
function li(e, t, n) {
    const r = this.cache,
        i = t.length,
        a = Ar(n, i);
    xr(r, a) || (e.uniform1iv(this.addr, a), Rr(r, a));
    for (let e = 0; e !== i; ++e) n.setTextureCube(t[e] || _r, a[e]);
}
function ci(e, t, n) {
    const r = this.cache,
        i = t.length,
        a = Ar(n, i);
    xr(r, a) || (e.uniform1iv(this.addr, a), Rr(r, a));
    for (let e = 0; e !== i; ++e) n.setTexture2DArray(t[e] || mr, a[e]);
}
class di {
    constructor(e, t, n) {
        (this.id = e),
...
function hi(e, t, n) {
    ...
    for (pi.lastIndex = 0; ; ) {
        ...
        if ((l && (s |= 0), void 0 === c || ('[' === c && o + 2 === i))) {
            mi(n, void 0 === c ? new di(s, e, t) : new ui(s, e, t));
            break;
        }
        {
            let e = n.map[s];
            void 0 === e && ((e = new fi(s)), mi(n, e)), (n = e);
        }
    }
}
class _i {
    constructor(e, t) {
        ...
        for (let r = 0; r < n; ++r) {
            ...
            hi(n, e.getUniformLocation(t, n.name), this);
        }
    }
    setValue(e, t, n, r) {
        const i = this.map[t];
...
function Ti(e, t) {
    const n = (function (e) {
        p._getMatrix(Ei, p.workingColorSpace, e);
        const t = `mat3( ${Ei.elements.map((e) => e.toFixed(4))} )`;
        switch (p.getTransfer(e)) {
            case se:
...
const xi = new i();
function Ri() {
    p.getLuminanceCoefficients(xi);
    return [
        'float luminance( const in vec3 rgb ) {',
        `\tconst vec3 weights = vec3( ${xi.x.toFixed(4)}, ${xi.y.toFixed(4)}, ${xi.z.toFixed(
            4
        )} );`,
...
function Oi(e, t, n, r) {
    ...
    const c = (function (e) {
            ...
            return (
                e.shadowMapType === $
                    ...
                    : e.shadowMapType === J && (t = 'SHADOWMAP_TYPE_VSM'),
                t
            );
        })(n),
        d = (function (e) {
    ...
    let g,
        v,
        E = n.glslVersion ? '#version ' + n.glslVersion + '\n' : '';
    n.isRawShaderMaterial
        ? ((g = ['#define SHADER_TYPE ' + n.shaderType, '#define SHADER_NAME ' + n.shaderName, h]
              .filter(Ai)
              .join('\n')),
          g.length > 0 && (g += '\n'),
          (v = ['#define SHADER_TYPE ' + n.shaderType, '#define SHADER_NAME ' + n.shaderName, h]
              .filter(Ai)
              .join('\n')),
          v.length > 0 && (v += '\n'))
        : ((g = [
          ...
          (v = [
              ...
              n.toneMapping !== D ? Pn.tonemapping_pars_fragment : '',
              n.toneMapping !== D ? Mi('toneMapping', n.toneMapping) : '',
        ...
        !0 !== n.isRawShaderMaterial &&
            ...
            (v =
                [
                    '#define varying in',
                    n.glslVersion === Z ? '' : 'layout(location = 0) out highp vec4 pc_fragColor;',
                    n.glslVersion === Z ? '' : '#define gl_FragColor pc_fragColor',
    ...
    return (
        (this.isReady = function () {
            return !1 === P && (P = i.getProgramParameter(_, 37297)), P;
        }),
...
class Bi {
    ...
    _getShaderStage(e) {
        ...
        let n = t.get(e);
        return void 0 === n && ((n = new Hi(e)), t.set(e, n)), n;
    }
}
class Hi {
    constructor(e) {
...
function Gi(e, t, n, r, i, o, s) {
    ...
    return {
        getParameters: function (o, l, f, S, T) {
            const M = S.fog,
                x = T.geometry,
                R = o.isMeshStandardMaterial ? S.environment : null,
                A = (o.isMeshStandardMaterial ? n : t).get(o.envMap || R),
                b = A && A.mapping === a ? A.image.height : null,
                C = v[o.type];
            null !== o.precision &&
                ((g = i.getMaxPrecision(o.precision)),
                g !== o.precision &&
                    console.warn(
            ...
            let U,
                ...
                N = 0;
            if (
                (void 0 !== x.morphAttributes.position && (N = 1),
                void 0 !== x.morphAttributes.normal && (N = 2),
                void 0 !== x.morphAttributes.color && (N = 3),
                C)
            ) {
                const e = Dn[C];
                (U = e.vertexShader), (w = e.fragmentShader);
            } else
                (U = o.vertexShader),
                    (w = o.fragmentShader),
                    d.update(o),
                    (y = d.getVertexShaderID(o)),
                    (I = d.getFragmentShaderID(o));
            const O = e.getRenderTarget(),
                ...
                ne = o.sheen > 0,
                re = o.transmission > 0,
                ie = Q && !!o.anisotropyMap,
                ae = J && !!o.clearcoatMap,
                oe = J && !!o.clearcoatNormalMap,
                se = J && !!o.clearcoatRoughnessMap,
                le = te && !!o.iridescenceMap,
                ce = te && !!o.iridescenceThicknessMap,
                de = ne && !!o.sheenColorMap,
                ue = ne && !!o.sheenRoughnessMap,
                _e = !!o.specularMap,
                ge = !!o.specularColorMap,
                ve = !!o.specularIntensityMap,
                Ee = re && !!o.transmissionMap,
                Se = re && !!o.thicknessMap,
                Te = !!o.gradientMap,
                Me = !!o.alphaMap,
                xe = o.alphaTest > 0,
                Re = !!o.alphaHash,
                Ae = !!o.extensions;
            let be = D;
            o.toneMapped && ((null !== O && !0 !== O.isXRRenderTarget) || (be = e.toneMapping));
            const Ce = {
                shaderID: C,
                shaderType: o.type,
                shaderName: o.name,
                ...
                precision: g,
                batching: G,
                batchingColor: G && null !== T._colorsTexture,
                instancing: H,
                instancingColor: H && null !== T.instanceColor,
                instancingMorph: H && null !== T.morphTexture,
                ...
                displacementMap: _ && j,
                emissiveMap: q,
                normalMapObjectSpace: K && o.normalMapType === he,
                normalMapTangentSpace: K && o.normalMapType === me,
                metalnessMap: Z,
                roughnessMap: $,
                anisotropy: Q,
                anisotropyMap: ie,
                ...
                thicknessMap: Se,
                gradientMap: Te,
                opaque: !1 === o.transparent && o.blending === pe && !1 === o.alphaToCoverage,
                alphaMap: Me,
                alphaTest: xe,
                alphaHash: Re,
                combine: o.combine,
                mapUv: V && E(o.map.channel),
                aoMapUv: W && E(o.aoMap.channel),
                lightMapUv: X && E(o.lightMap.channel),
                bumpMapUv: Y && E(o.bumpMap.channel),
                normalMapUv: K && E(o.normalMap.channel),
                displacementMapUv: j && E(o.displacementMap.channel),
                emissiveMapUv: q && E(o.emissiveMap.channel),
                metalnessMapUv: Z && E(o.metalnessMap.channel),
                roughnessMapUv: $ && E(o.roughnessMap.channel),
                anisotropyMapUv: ie && E(o.anisotropyMap.channel),
                clearcoatMapUv: ae && E(o.clearcoatMap.channel),
                clearcoatNormalMapUv: oe && E(o.clearcoatNormalMap.channel),
                clearcoatRoughnessMapUv: se && E(o.clearcoatRoughnessMap.channel),
                iridescenceMapUv: le && E(o.iridescenceMap.channel),
                iridescenceThicknessMapUv: ce && E(o.iridescenceThicknessMap.channel),
                sheenColorMapUv: de && E(o.sheenColorMap.channel),
                sheenRoughnessMapUv: ue && E(o.sheenRoughnessMap.channel),
                specularMapUv: _e && E(o.specularMap.channel),
                specularColorMapUv: ge && E(o.specularColorMap.channel),
                specularIntensityMapUv: ve && E(o.specularIntensityMap.channel),
                transmissionMapUv: Ee && E(o.transmissionMap.channel),
                thicknessMapUv: Se && E(o.thicknessMap.channel),
                alphaMapUv: Me && E(o.alphaMap.channel),
                ...
                pointsUvs: !0 === T.isPoints && !!x.attributes.uv && (V || Me),
                fog: !!M,
                useFog: !0 === o.fog,
                ...
                toneMapping: be,
                decodeVideoTexture:
                    V && !0 === o.map.isVideoTexture && p.getTransfer(o.map.colorSpace) === m,
                decodeVideoTextureEmissive:
                    q &&
                    !0 === o.emissiveMap.isVideoTexture &&
                    p.getTransfer(o.emissiveMap.colorSpace) === m,
                premultipliedAlpha: o.premultipliedAlpha,
                doubleSided: o.side === fe,
                flipSided: o.side === c,
                useDepthPacking: o.depthPacking >= 0,
                depthPacking: o.depthPacking || 0,
                index0AttributeName: o.index0AttributeName,
                extensionClipCullDistance:
                    Ae && !0 === o.extensions.clipCullDistance && r.has('WEBGL_clip_cull_distance'),
                extensionMultiDraw:
                    ((Ae && !0 === o.extensions.multiDraw) || G) && r.has('WEBGL_multi_draw'),
                rendererExtensionParallelShaderCompile: r.has('KHR_parallel_shader_compile'),
                customProgramCacheKey: o.customProgramCacheKey(),
            };
            return (
                (Ce.vertexUv1s = u.has(1)),
                (Ce.vertexUv2s = u.has(2)),
                (Ce.vertexUv3s = u.has(3)),
                u.clear(),
                Ce
            );
        },
        getProgramCacheKey: function (t) {
            ...
            return (
                !1 === t.isRawShaderMaterial &&
                    ...
                    (function (e, t) {
                        l.disableAll(), t.supportsVertexTextures && l.enable(0);
        ...
        acquireProgram: function (t, n) {
            ...
            return void 0 === r && ((r = new Oi(e, n, t, o)), f.push(r)), r;
        },
        releaseProgram: function (e) {
            if (0 == --e.usedTimes) {
                const t = f.indexOf(e);
                (f[t] = f[f.length - 1]), f.pop(), e.destroy();
            }
        },
...
function Wi() {
    ...
    return {
        ...
        push: function (e, t, o, s, l, c) {
            const d = a(e, t, o, s, l, c);
            o.transmission > 0 ? r.push(d) : !0 === o.transparent ? i.push(d) : n.push(d);
        },
        unshift: function (e, t, o, s, l, c) {
            const d = a(e, t, o, s, l, c);
            o.transmission > 0 ? r.unshift(d) : !0 === o.transparent ? i.unshift(d) : n.unshift(d);
        },
        finish: function () {
        ...
        sort: function (e, t) {
            n.length > 1 && n.sort(e || zi),
                r.length > 1 && r.sort(t || ki),
                i.length > 1 && i.sort(t || ki);
        },
    };
}
function Xi() {
        ...
        get: function (t) {
            ...
            switch (t.type) {
                ...
                case 'SpotLight':
                    ...
                    break;
                case 'PointLight':
                    r = { position: new i(), color: new n(), distance: 0, decay: 0 };
                    break;
                case 'HemisphereLight':
                    r = { direction: new i(), skyColor: new n(), groundColor: new n() };
                    break;
                case 'RectAreaLight':
                    r = {
                        color: new n(),
...
function qi(e) {
    ...
    for (let e = 0; e < 9; e++) a.probe.push(new i());
    const o = new i(),
        s = new f(),
        l = new f();
    return {
        setup: function (t) {
            ...
            let l = 0,
                ...
                v = 0;
            t.sort(ji);
            for (let e = 0, E = t.length; e < E; e++) {
                const E = t[e],
                    S = E.color,
                    T = E.intensity,
                    M = E.distance,
                    x = E.shadow && E.shadow.map ? E.shadow.map.texture : null;
                if (E.isAmbientLight) (i += S.r * T), (o += S.g * T), (s += S.b * T);
                else if (E.isLightProbe) {
                    for (let e = 0; e < 9; e++) a.probe[e].addScaledVector(E.sh.coefficients[e], T);
                    v++;
                } else if (E.isDirectionalLight) {
                    const e = n.get(E);
                    if ((e.color.copy(E.color).multiplyScalar(E.intensity), E.castShadow)) {
                        const e = E.shadow,
                            t = r.get(E);
                        (t.shadowIntensity = e.intensity),
                            ...
                            (a.directionalShadow[l] = t),
                            (a.directionalShadowMap[l] = x),
                            (a.directionalShadowMatrix[l] = E.shadow.matrix),
                            p++;
                    }
                    (a.directional[l] = e), l++;
                    ...
                    e.position.setFromMatrixPosition(E.matrixWorld),
                        ...
                        (e.distance = M),
                        (e.coneCos = Math.cos(E.angle)),
                        (e.penumbraCos = Math.cos(E.angle * (1 - E.penumbra))),
                        (e.decay = E.decay),
                        (a.spot[d] = e);
                    const t = E.shadow;
                    if (
                        (E.map &&
                            ((a.spotLightMap[_] = E.map),
                            _++,
                            t.updateMatrices(E),
                            E.castShadow && g++),
                        (a.spotLightMatrix[d] = t.matrix),
                        E.castShadow)
                    ) {
                        const e = r.get(E);
                    ...
                    const e = n.get(E);
                    e.color.copy(S).multiplyScalar(T),
                        e.halfWidth.set(0.5 * E.width, 0, 0),
                        e.halfHeight.set(0, 0.5 * E.height, 0),
                        (a.rectArea[u] = e),
                        u++;
                } else if (E.isPointLight) {
                    const e = n.get(E);
                    if (
                        (e.color.copy(E.color).multiplyScalar(E.intensity),
                        ...
                        (t.shadowIntensity = e.intensity),
                            ...
                            (a.pointShadow[c] = t),
                            (a.pointShadowMap[c] = x),
                            (a.pointShadowMatrix[c] = E.shadow.matrix),
                            m++;
                    }
                    (a.point[c] = e), c++;
                } else if (E.isHemisphereLight) {
                    const e = n.get(E);
                    e.skyColor.copy(E.color).multiplyScalar(T),
                        e.groundColor.copy(E.groundColor).multiplyScalar(T),
                        (a.hemi[f] = e),
                        f++;
                }
            }
            u > 0 &&
                (!0 === e.has('OES_texture_float_linear')
                    ? ((a.rectAreaLTC1 = Un.LTC_FLOAT_1), (a.rectAreaLTC2 = Un.LTC_FLOAT_2))
                    : ((a.rectAreaLTC1 = Un.LTC_HALF_1), (a.rectAreaLTC2 = Un.LTC_HALF_2))),
                (a.ambient[0] = i),
                (a.ambient[1] = o),
                (a.ambient[2] = s);
            const E = a.hash;
            (E.directionalLength === l &&
                E.pointLength === c &&
                E.spotLength === d &&
                E.rectAreaLength === u &&
                E.hemiLength === f &&
                E.numDirectionalShadows === p &&
                E.numPointShadows === m &&
                E.numSpotShadows === h &&
                E.numSpotMaps === _ &&
                E.numLightProbes === v) ||
                ((a.directional.length = l),
                (a.spot.length = d),
                (a.rectArea.length = u),
                (a.point.length = c),
                (a.hemi.length = f),
                (a.directionalShadow.length = p),
                (a.directionalShadowMap.length = p),
                (a.pointShadow.length = m),
                (a.pointShadowMap.length = m),
                (a.spotShadow.length = h),
                (a.spotShadowMap.length = h),
                (a.directionalShadowMatrix.length = p),
                (a.pointShadowMatrix.length = m),
                (a.spotLightMatrix.length = h + _ - g),
                (a.spotLightMap.length = _),
                (a.numSpotLightShadowsWithMaps = g),
                (a.numLightProbes = v),
                (E.directionalLength = l),
                (E.pointLength = c),
                (E.spotLength = d),
...
function Qi(e, n, r) {
    ...
    const E = new N();
    E.setAttribute('position', new O(new Float32Array([-1, -1, 0.5, 3, -1, 0.5, -1, 3, 0.5]), 3));
    const S = new o(E, g),
        T = this;
    ...
    function x(t, r) {
        ...
        g.defines.VSM_SAMPLES !== t.blurSamples &&
            ((g.defines.VSM_SAMPLES = t.blurSamples),
            (v.defines.VSM_SAMPLES = t.blurSamples),
            (g.needsUpdate = !0),
            (v.needsUpdate = !0)),
            null === t.mapPass && (t.mapPass = new I(a.x, a.y)),
            (g.uniforms.shadow_pass.value = t.map.texture),
            (g.uniforms.resolution.value = t.mapSize),
            (g.uniforms.radius.value = t.radius),
            e.setRenderTarget(t.mapPass),
            e.clear(),
            e.renderBufferDirect(r, null, i, g, S, null),
            (v.uniforms.shadow_pass.value = t.mapPass.texture),
            (v.uniforms.resolution.value = t.mapSize),
            (v.uniforms.radius.value = t.radius),
            e.setRenderTarget(t.map),
            e.clear(),
            e.renderBufferDirect(r, null, i, v, S, null);
    }
    function R(t, n, r, i) {
        let a = null;
        ...
        if (void 0 !== o) a = o;
            ...
            void 0 === r && ((r = {}), (p[e] = r));
            let i = r[t];
            void 0 === i && ((i = a.clone()), (r[t] = i), n.addEventListener('dispose', b)),
                (a = i);
        }
        if (
            ((a.visible = n.visible),
            ...
            (a.alphaTest = !0 === n.alphaToCoverage ? 0.5 : n.alphaTest),
            (a.map = n.map),
    ...
    function A(t, r, a, o, s) {
        if (!1 === t.visible) return;
        if (
            t.layers.test(r.layers) &&
            (t.isMesh || t.isLine || t.isPoints) &&
            (t.castShadow || (t.receiveShadow && s === J)) &&
            ...
            if (Array.isArray(l)) {
                ...
                for (let c = 0, d = n.length; c < d; c++) {
                    ...
                    if (u && u.visible) {
                        const n = R(t, u, o, s);
                        t.onBeforeShadow(e, t, r, a, i, n, d),
                            e.renderBufferDirect(a, null, i, n, t, d),
                            t.onAfterShadow(e, t, r, a, i, n, d);
                    }
                }
            } else if (l.visible) {
                const n = R(t, l, o, s);
                t.onBeforeShadow(e, t, r, a, i, n, null),
                    e.renderBufferDirect(a, null, i, n, t, null),
                    t.onAfterShadow(e, t, r, a, i, n, null);
            }
        }
        const l = t.children;
        for (let e = 0, t = l.length; e < t; e++) A(l[e], r, a, o, s);
    }
    function b(e) {
    ...
    this.render = function (t, n, r) {
        ...
        if (!1 === T.autoUpdate && !1 === T.needsUpdate) return;
        ...
        for (let o = 0, l = t.length; o < l; o++) {
            ...
            if (
                ...
                (a.x > m || a.y > m) &&
                    (a.x > m &&
                        ((s.x = Math.floor(m / h.x)), (a.x = s.x * h.x), (c.mapSize.x = s.x)),
                    a.y > m &&
                        ((s.y = Math.floor(m / h.y)), (a.y = s.y * h.y), (c.mapSize.y = s.y))),
                null === c.map || !0 === f || !0 === p)
            ) {
                const e = this.type !== J ? { minFilter: Te, magFilter: Te } : {};
                null !== c.map && c.map.dispose(),
                    (c.map = new I(a.x, a.y, e)),
            ...
            for (let e = 0; e < _; e++) {
                ...
                d.set(s.x * t.x, s.y * t.y, s.x * t.z, s.y * t.w),
                    u.viewport(d),
                    c.updateMatrices(l, e),
                    (i = c.getFrustum()),
                    A(n, r, c.camera, l, this.type);
            }
            !0 !== c.isPointLightShadow && this.type === J && x(c, r), (c.needsUpdate = !1);
        }
        (M = this.type), (T.needsUpdate = !1), e.setRenderTarget(o, l, c);
    };
}
const Ji = { [Ke]: Ye, [Xe]: ze, [We]: Ve, [Me]: ke, [Ye]: Ke, [ze]: Xe, [Ve]: We, [ke]: Me };
function ea(e, t) {
    const r = new (function () {
            let t = !1;
            const n = new k();
            let r = null;
            const i = new k(0, 0, 0, 0);
            return {
                setMask: function (n) {
    ...
    let l = {},
        ...
        L = null,
        P = null;
    const U = e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS);
    let D = !1,
        w = 0;
    const I = e.getParameter(e.VERSION);
    -1 !== I.indexOf('WebGL')
        ? ((w = parseFloat(/^WebGL (\d)/.exec(I)[1])), (D = w >= 1))
        : -1 !== I.indexOf('OpenGL ES') &&
          ((w = parseFloat(/^OpenGL ES (\d)/.exec(I)[1])), (D = w >= 2));
    let N = null,
        O = {};
    ...
    (z[e.TEXTURE_2D] = V(e.TEXTURE_2D, e.TEXTURE_2D, 1)),
        (z[e.TEXTURE_CUBE_MAP] = V(e.TEXTURE_CUBE_MAP, e.TEXTURE_CUBE_MAP_POSITIVE_X, 6)),
        (z[e.TEXTURE_2D_ARRAY] = V(e.TEXTURE_2D_ARRAY, e.TEXTURE_2D_ARRAY, 1, 1)),
        (z[e.TEXTURE_3D] = V(e.TEXTURE_3D, e.TEXTURE_3D, 1, 1)),
        r.setClear(0, 0, 0, 1),
        i.setClear(1),
        a.setClear(0),
        W(e.DEPTH_TEST),
        ...
        W(e.CULL_FACE),
        j(y);
    const Y = { [Ae]: e.FUNC_ADD, [Re]: e.FUNC_SUBTRACT, [xe]: e.FUNC_REVERSE_SUBTRACT };
    (Y[tt] = e.MIN), (Y[nt] = e.MAX);
    const K = {
        [Ge]: e.ZERO,
        [He]: e.ONE,
        [Be]: e.SRC_COLOR,
        [Fe]: e.SRC_ALPHA,
        [Oe]: e.SRC_ALPHA_SATURATE,
        [Ne]: e.DST_COLOR,
        [Ie]: e.DST_ALPHA,
        [ye]: e.ONE_MINUS_SRC_COLOR,
        [we]: e.ONE_MINUS_SRC_ALPHA,
        [De]: e.ONE_MINUS_DST_COLOR,
        [Ue]: e.ONE_MINUS_DST_ALPHA,
        [Pe]: e.CONSTANT_COLOR,
        [Le]: e.ONE_MINUS_CONSTANT_COLOR,
        [Ce]: e.CONSTANT_ALPHA,
        [be]: e.ONE_MINUS_CONSTANT_ALPHA,
    };
    function j(t, n, r, i, a, o, s, l, c, d) {
        if (t !== y) {
            if ((!1 === m && (W(e.BLEND), (m = !0)), t === $e))
                (a = a || n),
                    (o = o || r),
                    (s = s || i),
                    (n === _ && a === E) || (e.blendEquationSeparate(Y[n], Y[a]), (_ = n), (E = a)),
                    (r === g && i === v && o === S && s === T) ||
                        (e.blendFuncSeparate(K[r], K[i], K[o], K[s]),
                        (g = r),
                        (v = i),
                        (S = o),
                        (T = s)),
                    (!1 !== l.equals(M) && c === x) ||
                        (e.blendColor(l.r, l.g, l.b, c), M.copy(l), (x = c)),
                    (h = t),
                    (R = !1);
            else if (t !== h || d !== R) {
                if (
                    ((_ === Ae && E === Ae) || (e.blendEquation(e.FUNC_ADD), (_ = Ae), (E = Ae)), d)
                )
                    switch (t) {
                        case pe:
                            e.blendFuncSeparate(
    ...
    function $(t, n, r) {
        t
            ? (W(e.POLYGON_OFFSET_FILL),
              (L === n && P === r) || (e.polygonOffset(n, r), (L = n), (P = r)))
    ...
    return {
        ...
        drawBuffers: function (t, n) {
            let r = f,
                i = !1;
            if (t) {
                (r = u.get(n)), void 0 === r && ((r = []), u.set(n, r));
                const a = t.textures;
        ...
        setMaterial: function (t, n) {
            t.side === fe ? X(e.CULL_FACE) : W(e.CULL_FACE);
            let o = t.side === c;
            n && (o = !o),
                q(o),
                t.blending === pe && !1 === t.transparent
                    ? j(y)
                    : j(
                          t.blending,
                          t.blendEquation,
        ...
        activeTexture: function (t) {
            void 0 === t && (t = e.TEXTURE0 + U - 1), N !== t && (e.activeTexture(t), (N = t));
        },
        bindTexture: function (t, n, r) {
            void 0 === r && (r = null === N ? e.TEXTURE0 + U - 1 : N);
            let i = O[r];
...
function ta(e, n, r, i, a, o, s) {
    ...
    function g(e, t) {
        return _ ? new OffscreenCanvas(e, t) : Rt('canvas');
    }
    function v(e, t, n) {
        let r = 1;
        const i = $(e);
    ...
    function A(t, r, i, a, o = !1) {
        if (null !== t) {
            if (void 0 !== e[t]) return e[t];
            console.warn(
                "THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '" + t + "'"
            );
        }
        let s = r;
        if (
            ...
            const t = o ? se : p.getTransfer(a);
            i === e.FLOAT && (s = e.RGBA32F),
                i === e.HALF_FLOAT && (s = e.RGBA16F),
                i === e.UNSIGNED_BYTE && (s = t === m ? e.SRGB8_ALPHA8 : e.RGBA8),
    ...
    function b(t, n) {
        ...
        return (
            t
                ...
                : n === xt && (r = e.DEPTH_COMPONENT16),
            r
        );
    }
    function C(e, t) {
        return !0 === E(e) || (e.isFramebufferTexture && e.minFilter !== Te && e.minFilter !== B)
        ...
        t.removeEventListener('dispose', L),
            (function (e) {
                ...
                if (r) {
                    ...
                    i.usedTimes--,
                        0 === i.usedTimes && U(e),
                        0 === Object.keys(r).length && h.delete(n);
                }
                i.remove(e);
            })(t),
        ...
        n.removeEventListener('dispose', P),
            (function (t) {
                ...
                for (let t = 0, n = r.length; t < n; t++) {
                    const n = i.get(r[t]);
                    n.__webglTexture && (e.deleteTexture(n.__webglTexture), s.memory.textures--),
                        i.remove(r[t]);
                }
                i.remove(t);
            })(n);
    ...
    function U(t) {
        ...
        const r = t.source;
        delete h.get(r)[n.__cacheKey], s.memory.textures--;
    }
    let D = 0;
    function w(t, n) {
        const a = i.get(t);
        if (
            ...
            if (null === e)
                ...
                if (!1 !== e.complete) return void G(a, t, n);
                console.warn(
                    'THREE.WebGLRenderer: Texture marked for update but image is incomplete'
                );
            }
        }
        r.bindTexture(e.TEXTURE_2D, a.__webglTexture, e.TEXTURE0 + n);
    }
    const y = { [at]: e.REPEAT, [it]: e.CLAMP_TO_EDGE, [rt]: e.MIRRORED_REPEAT },
        I = {
            [Te]: e.NEAREST,
            [ct]: e.NEAREST_MIPMAP_NEAREST,
            [lt]: e.NEAREST_MIPMAP_LINEAR,
            [B]: e.LINEAR,
            [st]: e.LINEAR_MIPMAP_NEAREST,
            [ot]: e.LINEAR_MIPMAP_LINEAR,
        },
        N = {
            [_t]: e.NEVER,
            [ht]: e.ALWAYS,
    ...
    function O(t, r) {
        if (
            ...
            e.texParameteri(t, e.TEXTURE_WRAP_S, y[r.wrapS]),
            e.texParameteri(t, e.TEXTURE_WRAP_T, y[r.wrapT]),
            (t !== e.TEXTURE_3D && t !== e.TEXTURE_2D_ARRAY) ||
                e.texParameteri(t, e.TEXTURE_WRAP_R, y[r.wrapR]),
            e.texParameteri(t, e.TEXTURE_MAG_FILTER, I[r.magFilter]),
            e.texParameteri(t, e.TEXTURE_MIN_FILTER, I[r.minFilter]),
            r.compareFunction &&
                (e.texParameteri(t, e.TEXTURE_COMPARE_MODE, e.COMPARE_REF_TO_TEXTURE),
                e.texParameteri(t, e.TEXTURE_COMPARE_FUNC, N[r.compareFunction])),
            !0 === n.has('EXT_texture_filter_anisotropic'))
        ) {
            if (r.magFilter === Te) return;
            if (r.minFilter !== lt && r.minFilter !== ot) return;
            if (r.type === T && !1 === n.has('OES_texture_float_linear')) return;
    ...
    function H(t, n) {
        ...
        if (o !== t.__cacheKey) {
            ...
            void 0 !== i && (a[t.__cacheKey].usedTimes--, 0 === i.usedTimes && U(n)),
                (t.__cacheKey = o),
    ...
    function G(t, n, s) {
        let l = e.TEXTURE_2D;
        (n.isDataArrayTexture || n.isCompressedArrayTexture) && (l = e.TEXTURE_2D_ARRAY),
            n.isData3DTexture && (l = e.TEXTURE_3D);
        const c = H(t, n),
            d = n.source;
        ...
        if (d.version !== u.__version || !0 === c) {
            ...
            const t = p.getPrimaries(p.workingColorSpace),
                i = n.colorSpace === gt ? null : p.getPrimaries(n.colorSpace),
                f = n.colorSpace === gt || t === i ? e.NONE : e.BROWSER_DEFAULT_WEBGL;
            ...
            let m = v(n.image, !1, a.maxTextureSize);
            m = Z(n, m);
            const h = o.convert(n.format, n.colorSpace),
                _ = o.convert(n.type);
            let g,
                S = A(n.internalFormat, h, _, n.colorSpace, n.isVideoTexture);
            O(l, n);
            const T = n.mipmaps,
                R = !0 !== n.isVideoTexture,
                L = void 0 === u.__version || !0 === c,
                P = d.dataReady,
                U = C(n, m);
            if (n.isDepthTexture)
                (S = b(n.format === vt, n.type)),
                    L &&
                        (R
                            ? r.texStorage2D(e.TEXTURE_2D, 1, S, m.width, m.height)
                            : r.texImage2D(e.TEXTURE_2D, 0, S, m.width, m.height, 0, h, _, null));
            else if (n.isDataTexture)
                if (T.length > 0) {
                    R && L && r.texStorage2D(e.TEXTURE_2D, U, S, T[0].width, T[0].height);
                    ...
                    R
                        ? (L && r.texStorage2D(e.TEXTURE_2D, U, S, m.width, m.height),
                          P &&
                              r.texSubImage2D(
                                  e.TEXTURE_2D,
                                  0,
                ...
                if (n.isCompressedArrayTexture) {
                    R &&
                        L &&
                        r.texStorage3D(e.TEXTURE_2D_ARRAY, U, S, T[0].width, T[0].height, m.depth);
                                ...
                                if (R) {
                                    if (P)
                                        if (n.layerUpdates.size > 0) {
                                            const i = Et(g.width, g.height, n.format, n.type);
                                            for (const a of n.layerUpdates) {
                                                const n = g.data.subarray(
                                                    (a * i) / g.data.BYTES_PER_ELEMENT,
                ...
                if (R) {
                    if (
                        (L && r.texStorage3D(e.TEXTURE_2D_ARRAY, U, S, m.width, m.height, m.depth),
                        P)
                    )
                        if (n.layerUpdates.size > 0) {
                            const t = Et(m.width, m.height, n.format, n.type);
                            for (const i of n.layerUpdates) {
                                const n = m.data.subarray(
                                    (i * t) / m.data.BYTES_PER_ELEMENT,
                                    ((i + 1) * t) / m.data.BYTES_PER_ELEMENT
                                );
                                r.texSubImage3D(
                                    e.TEXTURE_2D_ARRAY,
                                    0,
                ...
                R
                    ? (L && r.texStorage3D(e.TEXTURE_3D, U, S, m.width, m.height, m.depth),
                      P &&
                          r.texSubImage3D(
                              e.TEXTURE_3D,
                              0,
                    ...
                    : r.texImage3D(e.TEXTURE_3D, 0, S, m.width, m.height, m.depth, 0, h, _, m.data);
            else if (n.isFramebufferTexture) {
                if (L)
                    if (R) r.texStorage2D(e.TEXTURE_2D, U, S, m.width, m.height);
                    else {
                        let t = m.width,
                            n = m.height;
                        for (let i = 0; i < U; i++)
                            r.texImage2D(e.TEXTURE_2D, i, S, t, n, 0, h, _, null),
                                (t >>= 1),
                                (n >>= 1);
                    }
            } else if (T.length > 0) {
                if (R && L) {
                    const t = $(T[0]);
                    r.texStorage2D(e.TEXTURE_2D, U, S, t.width, t.height);
                }
                for (let t = 0, n = T.length; t < n; t++)
                    (g = T[t]),
                        R
                            ? P && r.texSubImage2D(e.TEXTURE_2D, t, 0, 0, h, _, g)
                            : r.texImage2D(e.TEXTURE_2D, t, S, h, _, g);
                n.generateMipmaps = !1;
            } else if (R) {
                if (L) {
                    const t = $(m);
                ...
                P && r.texSubImage2D(e.TEXTURE_2D, 0, 0, 0, h, _, m);
            } else r.texImage2D(e.TEXTURE_2D, 0, S, h, _, m);
            E(n) && x(l), (u.__version = d.version), n.onUpdate && n.onUpdate(n);
        }
    ...
    function V(t, n, a, s, c, d) {
        const u = o.convert(a.format, a.colorSpace),
            f = o.convert(a.type),
            p = A(a.internalFormat, u, f, a.colorSpace),
            m = i.get(n),
            h = i.get(a);
        if (((h.__renderTarget = n), !m.__hasExternalTextures)) {
            const t = Math.max(1, n.width >> d),
                i = Math.max(1, n.height >> d);
            c === e.TEXTURE_3D || c === e.TEXTURE_2D_ARRAY
                ? r.texImage3D(c, d, p, t, i, n.depth, 0, u, f, null)
                : r.texImage2D(c, d, p, t, i, 0, u, f, null);
        }
        r.bindFramebuffer(e.FRAMEBUFFER, t),
            q(n)
                ...
                : (c === e.TEXTURE_2D ||
                      (c >= e.TEXTURE_CUBE_MAP_POSITIVE_X && c <= e.TEXTURE_CUBE_MAP_NEGATIVE_Z)) &&
                  e.framebufferTexture2D(e.FRAMEBUFFER, s, c, h.__webglTexture, d),
    ...
    function z(t, n, r) {
        if ((e.bindRenderbuffer(e.RENDERBUFFER, t), n.depthBuffer)) {
            const i = n.depthTexture,
                ...
                c = j(n);
            q(n)
                ? l.renderbufferStorageMultisampleEXT(e.RENDERBUFFER, c, o, n.width, n.height)
                : r
                ? e.renderbufferStorageMultisample(e.RENDERBUFFER, c, o, n.width, n.height)
            ...
            for (let i = 0; i < t.length; i++) {
                const a = t[i],
                    ...
                    c = o.convert(a.type),
                    d = A(a.internalFormat, s, c, a.colorSpace),
                    u = j(n);
                r && !1 === q(n)
                    ? e.renderbufferStorageMultisample(e.RENDERBUFFER, u, d, n.width, n.height)
                    : q(n)
                    ? l.renderbufferStorageMultisampleEXT(e.RENDERBUFFER, u, d, n.width, n.height)
    ...
    function k(t, n) {
        ...
        if (
            (r.bindFramebuffer(e.FRAMEBUFFER, t), !n.depthTexture || !n.depthTexture.isDepthTexture)
        )
            throw new Error('renderTarget.depthTexture must be an instance of THREE.DepthTexture');
        const a = i.get(n.depthTexture);
        (a.__renderTarget = n),
            (a.__webglTexture &&
            ...
            w(n.depthTexture, 0);
        const o = a.__webglTexture,
            s = j(n);
        if (n.depthTexture.format === St)
            q(n)
                ? l.framebufferTexture2DMultisampleEXT(
                      e.FRAMEBUFFER,
                      e.DEPTH_ATTACHMENT,
            ...
            if (n.depthTexture.format !== vt) throw new Error('Unknown depthTexture format');
            q(n)
                ? l.framebufferTexture2DMultisampleEXT(
                      e.FRAMEBUFFER,
    ...
    function W(t) {
        ...
        if (t.depthTexture && !n.__autoAllocateDepthBuffer) {
            ...
            e && e.length > 0 ? k(n.__webglFramebuffer[0], t) : k(n.__webglFramebuffer, t);
        } else if (a) {
            n.__webglDepthbuffer = [];
            for (let i = 0; i < 6; i++)
                if (
                    (r.bindFramebuffer(e.FRAMEBUFFER, n.__webglFramebuffer[i]),
                    void 0 === n.__webglDepthbuffer[i])
                )
                    (n.__webglDepthbuffer[i] = e.createRenderbuffer()),
                        z(n.__webglDepthbuffer[i], t, !1);
                else {
                    const r = t.stencilBuffer ? e.DEPTH_STENCIL_ATTACHMENT : e.DEPTH_ATTACHMENT,
                        a = n.__webglDepthbuffer[i];
                    e.bindRenderbuffer(e.RENDERBUFFER, a),
                        e.framebufferRenderbuffer(e.FRAMEBUFFER, r, e.RENDERBUFFER, a);
                }
        } else {
            const i = t.texture.mipmaps;
            if (
                (i && i.length > 0
                    ? r.bindFramebuffer(e.FRAMEBUFFER, n.__webglFramebuffer[0])
                    : r.bindFramebuffer(e.FRAMEBUFFER, n.__webglFramebuffer),
                void 0 === n.__webglDepthbuffer)
            )
                (n.__webglDepthbuffer = e.createRenderbuffer()), z(n.__webglDepthbuffer, t, !1);
            else {
                const r = t.stencilBuffer ? e.DEPTH_STENCIL_ATTACHMENT : e.DEPTH_ATTACHMENT,
    ...
    function $(e) {
        return (
            'undefined' != typeof HTMLImageElement && e instanceof HTMLImageElement
                ? ((d.width = e.naturalWidth || e.width), (d.height = e.naturalHeight || e.height))
                : 'undefined' != typeof VideoFrame && e instanceof VideoFrame
                ? ((d.width = e.displayWidth), (d.height = e.displayHeight))
    ...
    (this.allocateTextureUnit = function () {
        ...
        (this.setTexture2D = w),
        (this.setTexture2DArray = function (t, n) {
            const a = i.get(t);
            t.version > 0 && a.__version !== t.version
                ? G(a, t, n)
                : r.bindTexture(e.TEXTURE_2D_ARRAY, a.__webglTexture, e.TEXTURE0 + n);
        }),
        (this.setTexture3D = function (t, n) {
            const a = i.get(t);
            t.version > 0 && a.__version !== t.version
                ? G(a, t, n)
                : r.bindTexture(e.TEXTURE_3D, a.__webglTexture, e.TEXTURE0 + n);
        }),
            ...
            t.version > 0 && s.__version !== t.version
                ? (function (t, n, s) {
                      ...
                      if (c.version !== d.__version || !0 === l) {
                          ...
                          const t = p.getPrimaries(p.workingColorSpace),
                              i = n.colorSpace === gt ? null : p.getPrimaries(n.colorSpace),
                              u = n.colorSpace === gt || t === i ? e.NONE : e.BROWSER_DEFAULT_WEBGL;
                          e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL, n.flipY),
                              e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL, n.premultiplyAlpha),
                              e.pixelStorei(e.UNPACK_ALIGNMENT, n.unpackAlignment),
                              e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL, u);
                          const f = n.isCompressedTexture || n.image[0].isCompressedTexture,
                              m = n.image[0] && n.image[0].isDataTexture,
                              h = [];
                          for (let e = 0; e < 6; e++)
                              (h[e] =
                                  f || m
                                      ? m
                                          ? n.image[e].image
                                          : n.image[e]
                                      : v(n.image[e], !0, a.maxCubemapSize)),
                                  (h[e] = Z(n, h[e]));
                          const _ = h[0],
                              g = o.convert(n.format, n.colorSpace),
                              S = o.convert(n.type),
                              T = A(n.internalFormat, g, S, n.colorSpace),
                              R = !0 !== n.isVideoTexture,
                              b = void 0 === d.__version || !0 === l,
                              L = c.dataReady;
                          let P,
                              U = C(n, _);
                          if ((O(e.TEXTURE_CUBE_MAP, n), f)) {
                              R && b && r.texStorage2D(e.TEXTURE_CUBE_MAP, U, T, _.width, _.height);
                              for (let t = 0; t < 6; t++) {
                                  P = h[t].mipmaps;
                              ...
                              if (((P = n.mipmaps), R && b)) {
                                  P.length > 0 && U++;
                                  const t = $(h[0]);
                                  r.texStorage2D(e.TEXTURE_CUBE_MAP, U, T, t.width, t.height);
                              }
                              for (let t = 0; t < 6; t++)
                                  if (m) {
                                      R
                          ...
                          E(n) && x(e.TEXTURE_CUBE_MAP),
                              (d.__version = c.version),
                              n.onUpdate && n.onUpdate(n);
                      }
                      t.__version = n.version;
                  })(s, t, n)
                : r.bindTexture(e.TEXTURE_CUBE_MAP, s.__webglTexture, e.TEXTURE0 + n);
        }),
        (this.rebindTextures = function (t, n, r) {
            const a = i.get(t);
            void 0 !== n &&
                V(a.__webglFramebuffer, t, t.texture, e.COLOR_ATTACHMENT0, e.TEXTURE_2D, 0),
                void 0 !== r && W(t);
        }),
        (this.setupRenderTarget = function (t) {
            ...
            if (
                (u ||
                    (void 0 === l.__webglTexture && (l.__webglTexture = e.createTexture()),
                ...
                for (let t = 0; t < 6; t++)
                    if (n.mipmaps && n.mipmaps.length > 0) {
                        ...
                        for (let r = 0; r < n.mipmaps.length; r++)
                            a.__webglFramebuffer[t][r] = e.createFramebuffer();
                    } else a.__webglFramebuffer[t] = e.createFramebuffer();
            } else {
                if (n.mipmaps && n.mipmaps.length > 0) {
                    a.__webglFramebuffer = [];
                    for (let t = 0; t < n.mipmaps.length; t++)
                ...
                if (t.samples > 0 && !1 === q(t)) {
                    (a.__webglMultisampledFramebuffer = e.createFramebuffer()),
                        ...
                        r.bindFramebuffer(e.FRAMEBUFFER, a.__webglMultisampledFramebuffer);
                    for (let n = 0; n < c.length; n++) {
                        ...
                        const i = o.convert(r.format, r.colorSpace),
                            s = o.convert(r.type),
                            l = A(r.internalFormat, i, s, r.colorSpace, !0 === t.isXRRenderTarget),
                            d = j(t);
                        e.renderbufferStorageMultisample(e.RENDERBUFFER, d, l, t.width, t.height),
            ...
            if (d) {
                r.bindTexture(e.TEXTURE_CUBE_MAP, l.__webglTexture), O(e.TEXTURE_CUBE_MAP, n);
                for (let r = 0; r < 6; r++)
                    if (n.mipmaps && n.mipmaps.length > 0)
                        for (let i = 0; i < n.mipmaps.length; i++)
                            V(
                                a.__webglFramebuffer[r][i],
                                t,
                                n,
                                e.COLOR_ATTACHMENT0,
                ...
                E(n) && x(e.TEXTURE_CUBE_MAP), r.unbindTexture();
            } else if (u) {
                for (let n = 0, o = c.length; n < o; n++) {
                    const o = c[n],
                        s = i.get(o);
                    r.bindTexture(e.TEXTURE_2D, s.__webglTexture),
                        O(e.TEXTURE_2D, o),
                        V(a.__webglFramebuffer, t, o, e.COLOR_ATTACHMENT0 + n, e.TEXTURE_2D, 0),
                        E(o) && x(e.TEXTURE_2D);
                }
                r.unbindTexture();
            } else {
                ...
                if (
                    ...
                    r.bindTexture(i, l.__webglTexture),
                    O(i, n),
                    n.mipmaps && n.mipmaps.length > 0)
                )
                    for (let r = 0; r < n.mipmaps.length; r++)
                        V(a.__webglFramebuffer[r], t, n, e.COLOR_ATTACHMENT0, i, r);
                else V(a.__webglFramebuffer, t, n, e.COLOR_ATTACHMENT0, i, 0);
                E(n) && x(i), r.unbindTexture();
            }
            t.depthBuffer && W(t);
        }),
        (this.updateRenderTargetMipmap = function (e) {
            ...
            for (let n = 0, a = t.length; n < a; n++) {
                ...
                if (E(a)) {
                    const t = R(e),
                        n = i.get(a).__webglTexture;
                    r.bindTexture(t, n), x(t), r.unbindTexture();
                }
            }
        }),
                ...
                if (!1 === q(t)) {
                    ...
                    if (u)
                        for (let t = 0; t < n.length; t++)
                            r.bindFramebuffer(e.FRAMEBUFFER, d.__webglMultisampledFramebuffer),
                                e.framebufferRenderbuffer(
                                    e.FRAMEBUFFER,
                                ...
                                r.bindFramebuffer(e.FRAMEBUFFER, d.__webglFramebuffer),
                                e.framebufferTexture2D(
                                    e.DRAW_FRAMEBUFFER,
                                    e.COLOR_ATTACHMENT0 + t,
                                    e.TEXTURE_2D,
                    ...
                    r.bindFramebuffer(e.READ_FRAMEBUFFER, d.__webglMultisampledFramebuffer);
                    const f = t.texture.mipmaps;
                    f && f.length > 0
                        ? r.bindFramebuffer(e.DRAW_FRAMEBUFFER, d.__webglFramebuffer[0])
                        : r.bindFramebuffer(e.DRAW_FRAMEBUFFER, d.__webglFramebuffer);
                    for (let r = 0; r < n.length; r++) {
                        if (
                            ...
                            e.framebufferRenderbuffer(
                                ...
                                e.COLOR_ATTACHMENT0,
                                e.RENDERBUFFER,
                                d.__webglColorRenderbuffer[r]
                            );
                            const t = i.get(n[r]).__webglTexture;
                            e.framebufferTexture2D(
                                e.DRAW_FRAMEBUFFER,
                                e.COLOR_ATTACHMENT0,
                                e.TEXTURE_2D,
                        ...
                        e.blitFramebuffer(0, 0, a, o, 0, 0, a, o, s, e.NEAREST),
                            !0 === c &&
                                ((X.length = 0),
                                (Y.length = 0),
                                X.push(e.COLOR_ATTACHMENT0 + r),
                                t.depthBuffer &&
                                    !1 === t.resolveDepthBuffer &&
                                    (X.push(l),
                                    Y.push(l),
                                    e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER, Y)),
                                e.invalidateFramebuffer(e.READ_FRAMEBUFFER, X));
                    }
                    if (
                    ...
                    r.bindFramebuffer(e.DRAW_FRAMEBUFFER, d.__webglMultisampledFramebuffer);
...
function na(e, t) {
    return {
        convert: function (n, r = gt) {
            let i;
            const a = p.getTransfer(r);
            if (n === S) return e.UNSIGNED_BYTE;
            if (n === At) return e.UNSIGNED_SHORT_4_4_4_4;
            if (n === bt) return e.UNSIGNED_SHORT_5_5_5_1;
            if (n === Ct) return e.UNSIGNED_INT_5_9_9_9_REV;
            if (n === Lt) return e.BYTE;
            if (n === Pt) return e.SHORT;
            if (n === xt) return e.UNSIGNED_SHORT;
            if (n === v) return e.INT;
            if (n === Tt) return e.UNSIGNED_INT;
            if (n === T) return e.FLOAT;
            if (n === E) return e.HALF_FLOAT;
            if (n === Ut) return e.ALPHA;
            if (n === Dt) return e.RGB;
            if (n === M) return e.RGBA;
            if (n === St) return e.DEPTH_COMPONENT;
            if (n === vt) return e.DEPTH_STENCIL;
            if (n === wt) return e.RED;
            if (n === yt) return e.RED_INTEGER;
            if (n === It) return e.RG;
            if (n === Nt) return e.RG_INTEGER;
            if (n === Ot) return e.RGBA_INTEGER;
            if (n === Ft || n === Bt || n === Ht || n === Gt)
                if (a === m) {
                    if (((i = t.get('WEBGL_compressed_texture_s3tc_srgb')), null === i))
                        return null;
                    if (n === Ft) return i.COMPRESSED_SRGB_S3TC_DXT1_EXT;
                    if (n === Bt) return i.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;
                    if (n === Ht) return i.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;
                    if (n === Gt) return i.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT;
                } else {
                    if (((i = t.get('WEBGL_compressed_texture_s3tc')), null === i)) return null;
                    if (n === Ft) return i.COMPRESSED_RGB_S3TC_DXT1_EXT;
                    if (n === Bt) return i.COMPRESSED_RGBA_S3TC_DXT1_EXT;
                    if (n === Ht) return i.COMPRESSED_RGBA_S3TC_DXT3_EXT;
                    if (n === Gt) return i.COMPRESSED_RGBA_S3TC_DXT5_EXT;
                }
            if (n === Vt || n === zt || n === kt || n === Wt) {
                if (((i = t.get('WEBGL_compressed_texture_pvrtc')), null === i)) return null;
                if (n === Vt) return i.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;
                if (n === zt) return i.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;
                if (n === kt) return i.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;
                if (n === Wt) return i.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;
            }
            if (n === Xt || n === Yt || n === Kt) {
                if (((i = t.get('WEBGL_compressed_texture_etc')), null === i)) return null;
                if (n === Xt || n === Yt)
                    return a === m ? i.COMPRESSED_SRGB8_ETC2 : i.COMPRESSED_RGB8_ETC2;
                if (n === Kt)
                    return a === m
            ...
            if (n === cn || n === dn || n === un) {
                ...
                if (n === dn) return i.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;
                if (n === un) return i.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
            }
            if (n === fn || n === pn || n === mn || n === hn) {
                if (((i = t.get('EXT_texture_compression_rgtc')), null === i)) return null;
                if (n === cn) return i.COMPRESSED_RED_RGTC1_EXT;
                if (n === pn) return i.COMPRESSED_SIGNED_RED_RGTC1_EXT;
                if (n === mn) return i.COMPRESSED_RED_GREEN_RGTC2_EXT;
                if (n === hn) return i.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT;
            }
            return n === Mt ? e.UNSIGNED_INT_24_8 : void 0 !== e[n] ? e[n] : null;
        },
    };
}
class ra {
...
class ia extends _n {
    constructor(e, n) {
        ...
        function N() {
            a.removeEventListener('select', y),
                a.removeEventListener('selectstart', y),
                a.removeEventListener('selectend', y),
                a.removeEventListener('squeeze', y),
                a.removeEventListener('squeezestart', y),
                a.removeEventListener('squeezeend', y),
                a.removeEventListener('end', N),
        ...
        (this.cameraAutoUpdate = !0),
            ...
            (this.getController = function (e) {
                let t = T[e];
                return void 0 === t && ((t = new vn()), (T[e] = t)), t.getTargetRaySpace();
            }),
            (this.getControllerGrip = function (e) {
                let t = T[e];
                return void 0 === t && ((t = new vn()), (T[e] = t)), t.getGripSpace();
            }),
            (this.getHand = function (e) {
                let t = T[e];
                return void 0 === t && ((t = new vn()), (T[e] = t)), t.getHandSpace();
            }),
            ...
            (this.setSession = async function (t) {
                if (((a = t), null !== a)) {
                    (v = e.getRenderTarget()),
                        a.addEventListener('select', y),
                        a.addEventListener('selectstart', y),
                        a.addEventListener('selectend', y),
                        a.addEventListener('squeeze', y),
                        a.addEventListener('squeezestart', y),
                        a.addEventListener('squeezeend', y),
                    ...
                    if (
                        ...
                        let t = null,
                            ...
                            i = null;
                        g.depth &&
                            ((i = g.stencil ? n.DEPTH24_STENCIL8 : n.DEPTH_COMPONENT24),
                            (t = g.stencil ? vt : St),
                            (r = g.stencil ? Mt : Tt));
                        const s = { colorFormat: n.RGBA8, depthFormat: i, scaleFactor: o };
                        (f = new XRWebGLBinding(a, n)),
                            (p = f.createProjectionLayer(s)),
                            a.updateRenderState({ layers: [p] }),
                            e.setPixelRatio(1),
                            e.setSize(p.textureWidth, p.textureHeight, !1),
                            (E = new I(p.textureWidth, p.textureHeight, {
                                format: M,
                                type: S,
                                depthTexture: new j(
                                    p.textureWidth,
                        ...
                        (m = new XRWebGLLayer(a, n, t)),
                            ...
                            (E = new I(m.framebufferWidth, m.framebufferHeight, {
                                format: M,
                                type: S,
                                colorSpace: e.outputColorSpace,
                                stencilBuffer: g.stencil,
                    ...
                    (E.isXRRenderTarget = !0),
                        this.setFoveation(c),
                        (d = null),
                        (s = await a.requestReferenceSpace(l)),
                        V.setContext(a),
                        V.start(),
                        (r.isPresenting = !0),
        ...
        (this.updateCamera = function (e) {
            ...
            null !== _.texture &&
                ...
                (P.near = C.near = b.near = t),
                (P.far = C.far = b.far = n),
                (D === P.near && w === P.far) ||
                    (a.updateRenderState({ depthNear: P.near, depthFar: P.far }),
                    (D = P.near),
                    (w = P.far)),
                (b.layers.mask = 2 | e.layers.mask),
                (C.layers.mask = 4 | e.layers.mask),
                (P.layers.mask = b.layers.mask | C.layers.mask);
            const r = e.parent,
                i = P.cameras;
            H(P, r);
            for (let e = 0; e < i.length; e++) H(i[e], r);
            2 === i.length
                ? (function (e, t, n) {
                      F.setFromMatrixPosition(t.matrixWorld),
                          B.setFromMatrixPosition(n.matrixWorld);
                      const r = F.distanceTo(B),
                      ...
                      if (
                          ...
                          const t = o + m,
                              ...
                              d = ((l * s) / n) * t,
                              u = ((c * s) / n) * t;
                          e.projectionMatrix.makePerspective(i, a, d, u, t, n),
                              e.projectionMatrixInverse.copy(e.projectionMatrix).invert();
                      }
                  })(P, b, C)
                : P.projectionMatrix.copy(b.projectionMatrix),
                (function (e, t, n) {
                    null === n
                    ...
                    e.matrix.decompose(e.position, e.quaternion, e.scale),
                        ...
                        e.isPerspectiveCamera &&
                            ((e.fov = 2 * En * Math.atan(1 / e.projectionMatrix.elements[5])),
                            (e.zoom = 1));
                })(e, P, r);
        }),
        ...
        V.setAnimationLoop(function (t, n) {
            if (((u = n.getViewerPose(d || s)), (h = n), null !== u)) {
                const t = u.views;
                null !== m &&
                    (e.setRenderTargetFramebuffer(E, m.framebuffer), e.setRenderTarget(E));
                let n = !1;
                t.length !== P.cameras.length && ((P.cameras.length = 0), (n = !0));
                for (let r = 0; r < t.length; r++) {
                    const i = t[r];
                    let a = null;
                    if (null !== m) a = m.getViewport(i);
                    else {
                        const t = f.getViewSubImage(p, i);
                        (a = t.viewport),
                            0 === r &&
                    ...
                    let o = L[r];
                    void 0 === o &&
                        ((o = new U()), o.layers.enable(r), (o.viewport = new k()), (L[r] = o)),
                        ...
                        0 === r &&
                            (P.matrix.copy(o.matrix),
                            P.matrix.decompose(P.position, P.quaternion, P.scale)),
                        !0 === n && P.cameras.push(o);
                }
                const r = a.enabledFeatures;
                if (r && r.includes('depth-sensing') && 'gpu-optimized' == a.depthUsage && f) {
                    const n = f.getDepthInformation(t[0]);
                    n && n.isValid && n.texture && _.init(e, n, a.renderState);
                }
            }
            for (let e = 0; e < T.length; e++) {
                const t = x[e],
                    r = T[e];
                null !== t && void 0 !== r && r.update(t, n, d || s);
            }
            G && G(t, n),
                n.detectedPlanes && r.dispatchEvent({ type: 'planesdetected', data: n }),
                (h = null);
        }),
...
function sa(e, t) {
    ...
    function r(e, r) {
        ...
        a &&
            ...
            (aa.y *= -1),
            (aa.z *= -1),
            a.isCubeTexture && !1 === a.isRenderTargetTexture && ((aa.y *= -1), (aa.z *= -1)),
            e.envMapRotation.value.setFromMatrix4(oa.makeRotationFromEuler(aa)),
    ...
    return {
        refreshFogUniforms: function (t, n) {
            n.color.getRGB(t.fogColor.value, g(e)),
                n.isFog
    ...
    return {
        ...
        update: function (n, u) {
            ...
            void 0 === f &&
                ...
                (f = (function (t) {
                    const n = (function () {
                        for (let e = 0; e < s; e++) if (-1 === o.indexOf(e)) return o.push(e), e;
                        return (
                            console.error(
...
class ca {
    constructor(e = {}) {
        ...
        if (((this.isWebGLRenderer = !0), null !== r)) {
            if ('undefined' != typeof WebGLRenderingContext && r instanceof WebGLRenderingContext)
        ...
        try {
            ...
            if (
                ('setAttribute' in t && t.setAttribute('data-engine', `three.js r${Mn}`),
        ...
        function Oe() {
            (le = new or(Ie)),
                le.init(),
                (De = new na(Ie, le)),
                (ce = new Bn(Ie, le, e, De)),
                (de = new ea(Ie, le)),
                ce.reverseDepthBuffer && g && de.buffers.depth.setReversed(!0),
                (ue = new cr(Ie)),
                (pe = new Vi()),
                (me = new ta(Ie, le, de, pe, ce, De, ue)),
                (he = new Gn(C)),
                (_e = new ar(C)),
                (ve = new Ln(Ie)),
                (we = new On(Ie, ve)),
                (Ee = new sr(Ie, ve, ue, we)),
                (Se = new ur(Ie, Ee, ve, ue)),
                (Le = new dr(Ie, ce, me)),
                (Ae = new Hn(pe)),
                (Te = new Gi(C, he, _e, le, ce, we, Ae)),
                (Me = new sa(C, pe)),
                (xe = new Xi()),
                (Re = new $i(le)),
                (Ce = new Nn(C, he, _e, de, Se, v, d)),
                (be = new Qi(C, Se, ce)),
                (ye = new la(Ie, ue, ce, de)),
                (Pe = new Fn(Ie, le, ue)),
                (Ue = new lr(Ie, le, ue)),
                (ue.programs = Te.programs),
                (C.capabilities = ce),
                (C.extensions = le),
                (C.properties = pe),
                (C.renderLists = xe),
        ...
        function ze(e, t, n) {
            !0 === e.transparent && e.side === fe && !1 === e.forceSinglePass
                ? ((e.side = c),
                  (e.needsUpdate = !0),
                  Qe(e, t, n),
                  (e.side = _),
        ...
        (this.xr = Fe),
            ...
            (this.setPixelRatio = function (e) {
                void 0 !== e && ((Y = e), this.setSize(W, X, !1));
            }),
            ...
            (this.setSize = function (e, n, r = !0) {
                Fe.isPresenting
                    ...
                    : ((W = e),
                      ...
                      !0 === r && ((t.style.width = e + 'px'), (t.style.height = n + 'px')),
            ...
            (this.setViewport = function (e, t, n, r) {
                e.isVector4 ? q.set(e.x, e.y, e.z, e.w) : q.set(e, t, n, r),
                    de.viewport(O.copy(q).multiplyScalar(Y).round());
            }),
            ...
            (this.setScissor = function (e, t, n, r) {
                e.isVector4 ? Z.set(e.x, e.y, e.z, e.w) : Z.set(e, t, n, r),
                    de.scissor(B.copy(Z).multiplyScalar(Y).round());
            }),
                ...
                if (e) {
                    ...
                    if (e) {
                        const e = w.texture.type,
                            t = e === S || e === Tt || e === xt || e === Mt || e === At || e === bt,
                            n = Ce.getClearColor(),
                            r = Ce.getClearAlpha(),
                            i = n.r,
                            a = n.g,
                        ...
                        t
                            ? ((T[0] = i),
                              ...
                              (T[2] = o),
                              (T[3] = r),
                              Ie.clearBufferuiv(Ie.COLOR, 0, T))
                            : ((M[0] = i),
                              (M[1] = a),
                              (M[2] = o),
                              (M[3] = r),
                              Ie.clearBufferiv(Ie.COLOR, 0, M));
                    } else r |= Ie.COLOR_BUFFER_BIT;
                }
                t && (r |= Ie.DEPTH_BUFFER_BIT),
                    n &&
                        ((r |= Ie.STENCIL_BUFFER_BIT),
            ...
            (this.dispose = function () {
                t.removeEventListener('webglcontextlost', Be, !1),
                    ...
                    Te.dispose(),
                    Fe.dispose(),
                    Fe.removeEventListener('sessionstart', We),
            ...
            (this.renderBufferDirect = function (e, t, n, r, i, a) {
                ...
                const o = i.isMesh && i.matrixWorld.determinant() < 0,
                    s = (function (e, t, n, r, i) {
                        ...
                        const a = t.fog,
                            ...
                            s =
                                null === w
                                    ...
                                    : F,
                            l = (r.isMeshStandardMaterial ? _e : he).get(r.envMap || o),
                            c =
                                !0 === r.vertexColors &&
                                !!n.attributes.color &&
                        ...
                        let m = D;
                        r.toneMapped &&
                            ((null !== w && !0 !== w.isXRRenderTarget) || (m = C.toneMapping));
                        const h =
                                n.morphAttributes.position ||
                                n.morphAttributes.normal ||
                                n.morphAttributes.color,
                            _ = void 0 !== h ? h.length : 0,
                            g = pe.get(r),
                            v = R.state.lights;
                        if (!0 === J && (!0 === ee || e !== N)) {
                            const t = e === N && r.id === y;
                                        ...
                                        ? (i.isInstancedMesh &&
                                          ...
                                          (!0 === r.fog && g.fog !== a)
                                            ...
                                            : void 0 === g.numClippingPlanes ||
                                              (g.numClippingPlanes === Ae.numPlanes &&
                                                  g.numIntersection === Ae.numIntersection)
                                            ? (g.vertexAlphas !== c ||
                                                  g.vertexTangents !== d ||
                                                  g.morphTargets !== u ||
                                                  g.morphNormals !== f ||
                                                  g.morphColors !== p ||
                                                  g.toneMapping !== m ||
                                                  g.morphTargetsCount !== _) &&
                                              (E = !0)
                                            : (E = !0)
                                        : (E = !0)
                                    : (E = !0)
                                : (E = !0)
                            : ((E = !0), (g.__version = r.version));
                        ...
                        const A = S.getUniforms(),
                            b = g.uniforms;
                        de.useProgram(S.program) && ((T = !0), (M = !0), (x = !0));
                        r.id !== y && ((y = r.id), (M = !0));
                        if (T || N !== e) {
                            de.buffers.depth.getReversed()
                                ? (te.copy(e.projectionMatrix),
                                  xn(te),
                                  Rn(te),
                                  A.setValue(Ie, 'projectionMatrix', te))
                                : A.setValue(Ie, 'projectionMatrix', e.projectionMatrix),
                                A.setValue(Ie, 'viewMatrix', e.matrixWorldInverse);
                            const t = A.map.cameraPosition;
                            void 0 !== t && t.setValue(Ie, re.setFromMatrixPosition(e.matrixWorld)),
                                ...
                                (r.isMeshPhongMaterial ||
                                    ...
                                    r.isShaderMaterial) &&
                                    A.setValue(Ie, 'isOrthographic', !0 === e.isOrthographicCamera),
                                N !== e && ((N = e), (M = !0), (x = !0));
                        }
                        if (i.isSkinnedMesh) {
                            A.setOptional(Ie, i, 'bindMatrix'),
                                A.setOptional(Ie, i, 'bindMatrixInverse');
                            const e = i.skeleton;
                            e &&
                                (null === e.boneTexture && e.computeBoneTexture(),
                                A.setValue(Ie, 'boneTexture', e.boneTexture, me));
                        }
                        i.isBatchedMesh &&
                            (A.setOptional(Ie, i, 'batchingTexture'),
                            A.setValue(Ie, 'batchingTexture', i._matricesTexture, me),
                            A.setOptional(Ie, i, 'batchingIdTexture'),
                            A.setValue(Ie, 'batchingIdTexture', i._indirectTexture, me),
                            A.setOptional(Ie, i, 'batchingColorTexture'),
                            null !== i._colorsTexture &&
                                A.setValue(Ie, 'batchingColorTexture', i._colorsTexture, me));
                        const L = n.morphAttributes;
                        (void 0 === L.position && void 0 === L.normal && void 0 === L.color) ||
                            Le.update(i, n, S);
                        (M || g.receiveShadow !== i.receiveShadow) &&
                            ((g.receiveShadow = i.receiveShadow),
                            A.setValue(Ie, 'receiveShadow', i.receiveShadow));
                        ...
                        M &&
                            (A.setValue(Ie, 'toneMappingExposure', C.toneMappingExposure),
                            g.needsLights &&
                                ((U = x),
                                ((P = b).ambientLightColor.needsUpdate = U),
                            ...
                            a && !0 === r.fog && Me.refreshFogUniforms(b, a),
                            Me.refreshMaterialUniforms(
                                b,
                                r,
                                Y,
                                X,
                                R.state.transmissionRenderTarget[e.id]
                            ),
                            _i.upload(Ie, Je(g), b, me));
                        var P, U;
                        r.isShaderMaterial &&
                            !0 === r.uniformsNeedUpdate &&
                            (_i.upload(Ie, Je(g), b, me), (r.uniformsNeedUpdate = !1));
                        r.isSpriteMaterial && A.setValue(Ie, 'center', i.center);
                        if (
                            (A.setValue(Ie, 'modelViewMatrix', i.modelViewMatrix),
                            A.setValue(Ie, 'normalMatrix', i.normalMatrix),
                            A.setValue(Ie, 'modelMatrix', i.matrixWorld),
                ...
                let f = d.start * c,
                    p = (d.start + d.count) * c;
                null !== a &&
                    ((f = Math.max(f, a.start * c)), (p = Math.min(p, (a.start + a.count) * c))),
                    null !== l
                        ? ((f = Math.max(f, 0)), (p = Math.min(p, l.count)))
                        : null != u && ((f = Math.max(f, 0)), (p = Math.min(p, u.count)));
                const m = p - f;
                if (m < 0 || m === 1 / 0) return;
                let h;
                we.setup(i, r, s, n, l);
                let _ = Pe;
                if ((null !== l && ((h = ve.get(l)), (_ = Ue), _.setIndex(h)), i.isMesh))
                    !0 === r.wireframe
                        ? (de.setLineWidth(r.wireframeLinewidth * se()), _.setMode(Ie.LINES))
                        : _.setMode(Ie.TRIANGLES);
                else if (i.isLine) {
                    let e = r.linewidth;
                    void 0 === e && (e = 1),
                        de.setLineWidth(e * se()),
                        i.isLineSegments
                            ? _.setMode(Ie.LINES)
                            : i.isLineLoop
                            ? _.setMode(Ie.LINE_LOOP)
                            : _.setMode(Ie.LINE_STRIP);
                } else i.isPoints ? _.setMode(Ie.POINTS) : i.isSprite && _.setMode(Ie.TRIANGLES);
                if (i.isBatchedMesh)
                    if (null !== i._multiDrawInstances)
                        ...
                        const e = i._multiDrawStarts,
                            ...
                            n = i._multiDrawCount,
                            a = l ? ve.get(l).bytesPerElement : 1,
                            o = pe.get(r).currentProgram.getUniforms();
                        for (let r = 0; r < n; r++)
                            o.setValue(Ie, '_gl_DrawID', r), _.render(e[r] / a, t[r]);
                    }
                else if (i.isInstancedMesh) _.renderInstances(f, m, i.count);
                else if (n.isInstancedBufferGeometry) {
                    const e = void 0 !== n._maxInstanceCount ? n._maxInstanceCount : 1 / 0,
                        t = Math.min(n.instanceCount, e);
                    _.renderInstances(f, m, t);
                } else _.render(f, m);
            }),
                ...
                null === n && (n = e),
                    ...
                    n.traverseVisible(function (e) {
                        e.isLight &&
                            ...
                            (R.pushLight(e), e.castShadow && R.pushShadow(e));
                    }),
                    e !== n &&
            ...
            if (e.layers.test(t.layers))
                if (e.isGroup) n = e.renderOrder;
                    ...
                    if (!e.frustumCulled || Q.intersectsSprite(e)) {
                        r && ie.setFromMatrixPosition(e.matrixWorld).applyMatrix4(ne);
                        const t = Se.update(e),
                            i = e.material;
                        i.visible && x.push(e, t, i, n, ie.z, null);
                    }
                } else if (
                    ...
                    if (
                        (r &&
                            ...
                            ie.applyMatrix4(e.matrixWorld).applyMatrix4(ne)),
                        Array.isArray(i))
                    ) {
                        const r = t.groups;
                        for (let a = 0, o = r.length; a < o; a++) {
                            const o = r[a],
                                s = i[o.materialIndex];
                            s && s.visible && x.push(e, t, s, n, ie.z, o);
                        }
                    } else i.visible && x.push(e, t, i, n, ie.z, null);
                }
            const i = e.children;
            for (let e = 0, a = i.length; e < a; e++) Ke(i[e], t, n, r);
        }
        function je(e, t, n, r) {
            const i = e.opaque,
                a = e.transmissive,
                o = e.transparent;
            R.setupLightsView(n),
                !0 === J && Ae.setGlobalState(C.clippingPlanes, n),
                r && de.viewport(O.copy(r)),
                i.length > 0 && Ze(i, t, n),
                a.length > 0 && Ze(a, t, n),
                o.length > 0 && Ze(o, t, n),
        ...
        function qe(e, t, n, r) {
            ...
            void 0 === R.state.transmissionRenderTarget[r.id] &&
                (R.state.transmissionRenderTarget[r.id] = new I(1, 1, {
                    generateMipmaps: !0,
                    type:
                        le.has('EXT_color_buffer_half_float') || le.has('EXT_color_buffer_float')
                            ? E
                            : S,
                    minFilter: ot,
                    samples: 4,
                    ...
                    colorSpace: p.workingColorSpace,
                }));
            const i = R.state.transmissionRenderTarget[r.id],
                a = r.viewport || O;
            i.setSize(a.z * C.transmissionResolutionScale, a.w * C.transmissionResolutionScale);
            const s = C.getRenderTarget();
            C.setRenderTarget(i),
                C.getClearColor(V),
                (z = C.getClearAlpha()),
                z < 1 && C.setClearColor(16777215, 0.5),
                C.clear(),
                oe && Ce.render(n);
            ...
            if (
                ...
                R.setupLightsView(r),
                !0 === J && Ae.setGlobalState(C.clippingPlanes, r),
                Ze(e, n, r),
                me.updateMultisampleRenderTarget(i),
                me.updateRenderTargetMipmap(i),
                ...
                for (let i = 0, a = t.length; i < a; i++) {
                    const a = t[i],
                        ...
                        l = a.material,
                        d = a.group;
                    if (l.side === fe && o.layers.test(r.layers)) {
                        const t = l.side;
                        (l.side = c),
                            (l.needsUpdate = !0),
                            $e(o, n, r, s, l, d),
                ...
                !0 === e && (me.updateMultisampleRenderTarget(i), me.updateRenderTargetMipmap(i));
            }
            C.setRenderTarget(s),
                C.setClearColor(V, z),
        ...
        function Ze(e, t, n) {
            ...
            for (let i = 0, a = e.length; i < a; i++) {
                ...
                !0 === c.allowOverride && null !== r && (c = r),
                    o.layers.test(n.layers) && $e(o, t, n, s, c, l);
            }
        }
        function $e(e, t, n, r, i, a) {
            e.onBeforeRender(C, t, n, r, i, a),
                e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse, e.matrixWorld),
                e.normalMatrix.getNormalMatrix(e.modelViewMatrix),
                i.onBeforeRender(C, t, n, r, e, a),
                !0 === i.transparent && i.side === fe && !1 === i.forceSinglePass
                    ? ((i.side = c),
                      (i.needsUpdate = !0),
                      C.renderBufferDirect(n, t, r, i, e, a),
                      (i.side = _),
                      (i.needsUpdate = !0),
                      C.renderBufferDirect(n, t, r, i, e, a),
                      (i.side = fe))
                    : C.renderBufferDirect(n, t, r, i, e, a),
                e.onAfterRender(C, t, n, r, i, a);
        }
        function Qe(e, t, n) {
            !0 !== t.isScene && (t = ae);
            const r = pe.get(e),
                i = R.state.lights,
                a = R.state.shadowsArray,
                o = i.state.version,
                s = Te.getParameters(e, i.state, a, t, n),
                l = Te.getProgramCacheKey(s);
            let c = r.programs;
            (r.environment = e.isMeshStandardMaterial ? t.environment : null),
                (r.fog = t.fog),
                (r.envMap = (e.isMeshStandardMaterial ? _e : he).get(e.envMap || r.environment)),
                (r.envMapRotation =
                    null !== r.environment && null === e.envMap
                        ? t.environmentRotation
                        : e.envMapRotation),
                void 0 === c &&
                    (e.addEventListener('dispose', Ve), (c = new Map()), (r.programs = c));
            let d = c.get(l);
            if (void 0 !== d) {
        ...
        function Je(e) {
            if (null === e.uniformsList) {
                ...
                e.uniformsList = _i.seqWithValue(t.seq, e.uniforms);
            }
        ...
        Ye.setAnimationLoop(function (e) {
            ...
            'undefined' != typeof self && Ye.setContext(self),
            (this.setAnimationLoop = function (e) {
                (ke = e), Fe.setAnimationLoop(e), null === e ? Ye.stop() : Ye.start();
            }),
            Fe.addEventListener('sessionstart', We),
            ...
            (this.render = function (e, t) {
                ...
                if (
                    ...
                    !0 === e.isScene && e.onBeforeRender(C, e, t, w),
                    (R = Re.get(e, b.length)),
                    R.init(t),
                    b.push(R),
                    ne.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse),
                    Q.setFromProjectionMatrix(ne),
                    (ee = this.localClippingEnabled),
                    (J = Ae.init(this.clippingPlanes, ee)),
                    (x = xe.get(e, A.length)),
                    x.init(),
                    A.push(x),
                    !0 === Fe.enabled && !0 === Fe.isPresenting)
                ) {
                    const e = C.xr.getDepthSensingMesh();
                    null !== e && Ke(e, t, -1 / 0, C.sortObjects);
                }
                Ke(e, t, 0, C.sortObjects),
                    x.finish(),
                    !0 === C.sortObjects && x.sort(K, j),
                    (oe =
                        !1 === Fe.enabled || !1 === Fe.isPresenting || !1 === Fe.hasDepthSensing()),
                    oe && Ce.addToRenderList(x, e),
                ...
                const r = x.opaque,
                    i = x.transmissive;
                if ((R.setupLights(), t.isArrayCamera)) {
                    const n = t.cameras;
                    if (i.length > 0)
                ...
                } else i.length > 0 && qe(r, i, e, t), oe && Ce.render(e), je(x, e, t);
                null !== w &&
                    0 === U &&
                    (me.updateMultisampleRenderTarget(w), me.updateRenderTargetMipmap(w)),
                    ...
                    b.length > 0
                        ? ((R = b[b.length - 1]),
                          !0 === J && Ae.setGlobalState(C.clippingPlanes, R.state.camera))
                        : (R = null),
                    A.pop(),
                    (x = A.length > 0 ? A[A.length - 1] : null);
            }),
            ...
            (this.setRenderTargetTextures = function (e, t, n) {
                ...
                (r.__autoAllocateDepthBuffer = !1 === e.resolveDepthBuffer),
                    ...
                    (pe.get(e.depthTexture).__webglTexture = r.__autoAllocateDepthBuffer
                        ? void 0
                        : n),
        ...
        (this.setRenderTarget = function (e, t = 0, n = 0) {
            ...
            if (e) {
                ...
                if (void 0 !== s.__useDefaultFramebuffer)
                    de.bindFramebuffer(Ie.FRAMEBUFFER, null), (r = !1);
                else if (void 0 === s.__webglFramebuffer) me.setupRenderTarget(e);
                ...
                e.isWebGLCubeRenderTarget
                    ...
                    : (i =
                          e.samples > 0 && !1 === me.useMultisampledRTT(e)
                ...
                O.copy(q).multiplyScalar(Y).floor(), B.copy(Z).multiplyScalar(Y).floor(), (G = $);
            0 !== n && (i = tt);
            if (
                (de.bindFramebuffer(Ie.FRAMEBUFFER, i) && r && de.drawBuffers(e, i),
                de.viewport(O),
                de.scissor(B),
                de.setScissorTest(G),
                a)
            ) {
                const r = pe.get(e.texture);
                Ie.framebufferTexture2D(
                    Ie.FRAMEBUFFER,
                    Ie.COLOR_ATTACHMENT0,
                    Ie.TEXTURE_CUBE_MAP_POSITIVE_X + t,
                    r.__webglTexture,
                    n
                );
            } else if (o) {
            ...
            (this.readRenderTargetPixels = function (e, t, n, r, i, a, o) {
                ...
                let s = pe.get(e).__webglFramebuffer;
                if ((e.isWebGLCubeRenderTarget && void 0 !== o && (s = s[o]), s)) {
                    de.bindFramebuffer(Ie.FRAMEBUFFER, s);
                    try {
                        const o = e.texture,
                            s = o.format,
                            l = o.type;
                        if (!ce.textureFormatReadable(s))
                            return void console.error(
                        ...
                        t >= 0 &&
                            ...
                            n >= 0 &&
                            n <= e.height - i &&
                            Ie.readPixels(t, n, r, i, De.convert(s), De.convert(l), a);
                    } finally {
                        const e = null !== w ? pe.get(w).__webglFramebuffer : null;
                        de.bindFramebuffer(Ie.FRAMEBUFFER, e);
                    }
                }
            }),
            (this.readRenderTargetPixelsAsync = async function (e, t, n, r, i, a, o) {
                ...
                if ((e.isWebGLCubeRenderTarget && void 0 !== o && (s = s[o]), s)) {
                    if (t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i) {
                        ...
                        const d = Ie.createBuffer();
                        Ie.bindBuffer(Ie.PIXEL_PACK_BUFFER, d),
                            Ie.bufferData(Ie.PIXEL_PACK_BUFFER, a.byteLength, Ie.STREAM_READ),
                            Ie.readPixels(t, n, r, i, De.convert(l), De.convert(c), 0);
                        const u = null !== w ? pe.get(w).__webglFramebuffer : null;
                        de.bindFramebuffer(Ie.FRAMEBUFFER, u);
                        const f = Ie.fenceSync(Ie.SYNC_GPU_COMMANDS_COMPLETE, 0);
                        return (
                            Ie.flush(),
                            await An(Ie, f, 4),
                            Ie.bindBuffer(Ie.PIXEL_PACK_BUFFER, d),
                            Ie.getBufferSubData(Ie.PIXEL_PACK_BUFFER, 0, a),
                            Ie.deleteBuffer(d),
                            Ie.deleteSync(f),
                            a
                        );
            ...
            (this.copyFramebufferToTexture = function (e, t = null, n = 0) {
                const r = Math.pow(2, -n),
                    ...
                    s = null !== t ? t.y : 0;
                me.setTexture2D(e, 0),
                    Ie.copyTexSubImage2D(Ie.TEXTURE_2D, n, 0, 0, o, s, i, a),
                    de.unbindTexture();
            });
        const nt = Ie.createFramebuffer(),
            rt = Ie.createFramebuffer();
        (this.copyTextureToTexture = function (e, t, n = null, r = null, i = 0, a = null) {
            let o, s, l, c, d, u, f, p, m;
            null === a &&
                (0 !== i
                    ? (H(
                      ...
                      (i = 0))
                    : (a = 0));
            const h = e.isCompressedTexture ? e.mipmaps[a] : e.image;
            if (null !== n)
                (o = n.max.x - n.min.x),
                    (s = n.max.y - n.min.y),
            ...
            null !== r ? ((f = r.x), (p = r.y), (m = r.z)) : ((f = 0), (p = 0), (m = 0));
            const _ = De.convert(t.format),
                g = De.convert(t.type);
            let v;
            t.isData3DTexture
                ? (me.setTexture3D(t, 0), (v = Ie.TEXTURE_3D))
                : t.isDataArrayTexture || t.isCompressedArrayTexture
                ? (me.setTexture2DArray(t, 0), (v = Ie.TEXTURE_2D_ARRAY))
                : (me.setTexture2D(t, 0), (v = Ie.TEXTURE_2D)),
                Ie.pixelStorei(Ie.UNPACK_FLIP_Y_WEBGL, t.flipY),
                Ie.pixelStorei(Ie.UNPACK_PREMULTIPLY_ALPHA_WEBGL, t.premultiplyAlpha),
                Ie.pixelStorei(Ie.UNPACK_ALIGNMENT, t.unpackAlignment);
            const E = Ie.getParameter(Ie.UNPACK_ROW_LENGTH),
                S = Ie.getParameter(Ie.UNPACK_IMAGE_HEIGHT),
                T = Ie.getParameter(Ie.UNPACK_SKIP_PIXELS),
                M = Ie.getParameter(Ie.UNPACK_SKIP_ROWS),
                x = Ie.getParameter(Ie.UNPACK_SKIP_IMAGES);
            Ie.pixelStorei(Ie.UNPACK_ROW_LENGTH, h.width),
                Ie.pixelStorei(Ie.UNPACK_IMAGE_HEIGHT, h.height),
                Ie.pixelStorei(Ie.UNPACK_SKIP_PIXELS, c),
                Ie.pixelStorei(Ie.UNPACK_SKIP_ROWS, d),
                Ie.pixelStorei(Ie.UNPACK_SKIP_IMAGES, u);
            const R = e.isDataArrayTexture || e.isData3DTexture,
                A = t.isDataArrayTexture || t.isData3DTexture;
            if (e.isDepthTexture) {
                const n = pe.get(e),
                    r = pe.get(t),
                    h = pe.get(n.__renderTarget),
                    _ = pe.get(r.__renderTarget);
                de.bindFramebuffer(Ie.READ_FRAMEBUFFER, h.__webglFramebuffer),
                    de.bindFramebuffer(Ie.DRAW_FRAMEBUFFER, _.__webglFramebuffer);
                for (let n = 0; n < l; n++)
                    R &&
                        (Ie.framebufferTextureLayer(
                            Ie.READ_FRAMEBUFFER,
                        ...
                        Ie.blitFramebuffer(c, d, o, s, f, p, o, s, Ie.DEPTH_BUFFER_BIT, Ie.NEAREST);
                de.bindFramebuffer(Ie.READ_FRAMEBUFFER, null),
                    de.bindFramebuffer(Ie.DRAW_FRAMEBUFFER, null);
            } else if (0 !== i || e.isRenderTargetTexture || pe.has(e)) {
                const n = pe.get(e),
                    r = pe.get(t);
                de.bindFramebuffer(Ie.READ_FRAMEBUFFER, nt),
                    de.bindFramebuffer(Ie.DRAW_FRAMEBUFFER, rt);
                for (let e = 0; e < l; e++)
                    R
                        ? Ie.framebufferTextureLayer(
                              Ie.READ_FRAMEBUFFER,
                        ...
                        0 !== i
                            ...
                            : A
                            ? Ie.copyTexSubImage3D(v, a, f, p, m + e, c, d, o, s)
                            : Ie.copyTexSubImage2D(v, a, f, p, c, d, o, s);
                de.bindFramebuffer(Ie.READ_FRAMEBUFFER, null),
                    de.bindFramebuffer(Ie.DRAW_FRAMEBUFFER, null);
            } else
                A
                    ? e.isDataTexture || e.isData3DTexture
                        ? Ie.texSubImage3D(v, a, f, p, m, o, s, l, _, g, h.data)
                        : t.isCompressedArrayTexture
                        ? Ie.compressedTexSubImage3D(v, a, f, p, m, o, s, l, _, h.data)
                        : Ie.texSubImage3D(v, a, f, p, m, o, s, l, _, g, h)
                    : e.isDataTexture
                    ? Ie.texSubImage2D(Ie.TEXTURE_2D, a, f, p, o, s, _, g, h.data)
                    ...
                    : Ie.texSubImage2D(Ie.TEXTURE_2D, a, f, p, o, s, _, g, h);
            Ie.pixelStorei(Ie.UNPACK_ROW_LENGTH, E),
                Ie.pixelStorei(Ie.UNPACK_IMAGE_HEIGHT, S),
                Ie.pixelStorei(Ie.UNPACK_SKIP_PIXELS, T),
                Ie.pixelStorei(Ie.UNPACK_SKIP_ROWS, M),
                Ie.pixelStorei(Ie.UNPACK_SKIP_IMAGES, x),
                0 === a && t.generateMipmaps && Ie.generateMipmap(v),
                de.unbindTexture();
        }),
            ...
            (this.initRenderTarget = function (e) {
                void 0 === pe.get(e).__webglFramebuffer && me.setupRenderTarget(e);
            }),
            (this.initTexture = function (e) {
                e.isCubeTexture
                    ? me.setTextureCube(e, 0)
                    : e.isData3DTexture
                    ? me.setTexture3D(e, 0)
                    : e.isDataArrayTexture || e.isCompressedArrayTexture
                    ? me.setTexture2DArray(e, 0)
                    : me.setTexture2D(e, 0),
                    de.unbindTexture();
            }),
            (this.resetState = function () {
                (P = 0), (U = 0), (w = null), de.reset(), we.reset();
            }),
    ...
    set outputColorSpace(e) {
        ...
        (t.drawingBufferColorSpace = p._getDrawingBufferColorSpace(e)),
            (t.unpackColorSpace = p._getUnpackColorSpace());
    }
}
export {
    re as ACESFilmicToneMapping,
    Ae as AddEquation,
    le as AddOperation,
    et as AdditiveBlending,
    ne as AgXToneMapping,
    Ut as AlphaFormat,
    ht as AlwaysCompare,
    Ye as AlwaysDepth,
    gn as ArrayCamera,
    c as BackSide,
    s as BoxGeometry,
    O as BufferAttribute,
    N as BufferGeometry,
    Lt as ByteType,
    ie as CineonToneMapping,
    it as ClampToEdgeWrapping,
    n as Color,
    p as ColorManagement,
    Ce as ConstantAlphaFactor,
    Pe as ConstantColorFactor,
    C as CubeReflectionMapping,
    L as CubeRefractionMapping,
    X as CubeTexture,
    a as CubeUVReflectionMapping,
    qe as CullFaceBack,
    Ze as CullFaceFront,
    je as CullFaceNone,
    $e as CustomBlending,
    ee as CustomToneMapping,
    Y as Data3DTexture,
    W as DataArrayTexture,
    St as DepthFormat,
    vt as DepthStencilFormat,
    j as DepthTexture,
    fe as DoubleSide,
    Ie as DstAlphaFactor,
    Ne as DstColorFactor,
    pt as EqualCompare,
    We as EqualDepth,
    R as EquirectangularReflectionMapping,
    A as EquirectangularRefractionMapping,
    u as Euler,
    _n as EventDispatcher,
    T as FloatType,
    _ as FrontSide,
    ge as Frustum,
    Z as GLSL3,
    ut as GreaterCompare,
    ze as GreaterDepth,
    ft as GreaterEqualCompare,
    ke as GreaterEqualDepth,
    E as HalfFloatType,
    v as IntType,
    _e as Layers,
    mt as LessCompare,
    Xe as LessDepth,
    K as LessEqualCompare,
    Me as LessEqualDepth,
    B as LinearFilter,
    ot as LinearMipmapLinearFilter,
    st as LinearMipmapNearestFilter,
    F as LinearSRGBColorSpace,
    oe as LinearToneMapping,
    se as LinearTransfer,
    e as Matrix3,
    f as Matrix4,
    nt as MaxEquation,
    o as Mesh,
    w as MeshBasicMaterial,
    ve as MeshDepthMaterial,
    Se as MeshDistanceMaterial,
    tt as MinEquation,
    rt as MirroredRepeatWrapping,
    ce as MixOperation,
    Qe as MultiplyBlending,
    de as MultiplyOperation,
    Te as NearestFilter,
    lt as NearestMipmapLinearFilter,
    ct as NearestMipmapNearestFilter,
    te as NeutralToneMapping,
    _t as NeverCompare,
    Ke as NeverDepth,
    y as NoBlending,
    gt as NoColorSpace,
    D as NoToneMapping,
    pe as NormalBlending,
    dt as NotEqualCompare,
    Ve as NotEqualDepth,
    he as ObjectSpaceNormalMap,
    He as OneFactor,
    be as OneMinusConstantAlphaFactor,
    Le as OneMinusConstantColorFactor,
    Ue as OneMinusDstAlphaFactor,
    De as OneMinusDstColorFactor,
    we as OneMinusSrcAlphaFactor,
    ye as OneMinusSrcColorFactor,
    P as OrthographicCamera,
    $ as PCFShadowMap,
    Q as PCFSoftShadowMap,
    Jn as PMREMGenerator,
    U as PerspectiveCamera,
    x as Plane,
    h as PlaneGeometry,
    mn as RED_GREEN_RGTC2_Format,
    fn as RED_RGTC1_Format,
    Mn as REVISION,
    Ee as RGBADepthPacking,
    M as RGBAFormat,
    Ot as RGBAIntegerFormat,
    on as RGBA_ASTC_10x10_Format,
    nn as RGBA_ASTC_10x5_Format,
    rn as RGBA_ASTC_10x6_Format,
    an as RGBA_ASTC_10x8_Format,
    sn as RGBA_ASTC_12x10_Format,
    ln as RGBA_ASTC_12x12_Format,
    jt as RGBA_ASTC_4x4_Format,
    qt as RGBA_ASTC_5x4_Format,
    Zt as RGBA_ASTC_5x5_Format,
    $t as RGBA_ASTC_6x5_Format,
    Qt as RGBA_ASTC_6x6_Format,
    Jt as RGBA_ASTC_8x5_Format,
    en as RGBA_ASTC_8x6_Format,
    tn as RGBA_ASTC_8x8_Format,
    cn as RGBA_BPTC_Format,
    Kt as RGBA_ETC2_EAC_Format,
    Wt as RGBA_PVRTC_2BPPV1_Format,
    kt as RGBA_PVRTC_4BPPV1_Format,
    Bt as RGBA_S3TC_DXT1_Format,
    Ht as RGBA_S3TC_DXT3_Format,
    Gt as RGBA_S3TC_DXT5_Format,
    Dt as RGBFormat,
    dn as RGB_BPTC_SIGNED_Format,
    un as RGB_BPTC_UNSIGNED_Format,
    Xt as RGB_ETC1_Format,
    Yt as RGB_ETC2_Format,
    zt as RGB_PVRTC_2BPPV1_Format,
    Vt as RGB_PVRTC_4BPPV1_Format,
    Ft as RGB_S3TC_DXT1_Format,
    It as RGFormat,
    Nt as RGIntegerFormat,
    wt as RedFormat,
    yt as RedIntegerFormat,
    ae as ReinhardToneMapping,
    at as RepeatWrapping,
    xe as ReverseSubtractEquation,
    hn as SIGNED_RED_GREEN_RGTC2_Format,
    pn as SIGNED_RED_RGTC1_Format,
    Tn as SRGBColorSpace,
    m as SRGBTransfer,
    Pn as ShaderChunk,
    Dn as ShaderLib,
    l as ShaderMaterial,
    Pt as ShortType,
    Fe as SrcAlphaFactor,
    Oe as SrcAlphaSaturateFactor,
    Be as SrcColorFactor,
    Re as SubtractEquation,
    Je as SubtractiveBlending,
    me as TangentSpaceNormalMap,
    q as Texture,
    V as Uint16BufferAttribute,
    G as Uint32BufferAttribute,
    Un as UniformsLib,
    ue as UniformsUtils,
    S as UnsignedByteType,
    Mt as UnsignedInt248Type,
    Ct as UnsignedInt5999Type,
    Tt as UnsignedIntType,
    At as UnsignedShort4444Type,
    bt as UnsignedShort5551Type,
    xt as UnsignedShortType,
    J as VSMShadowMap,
    t as Vector2,
    i as Vector3,
    k as Vector4,
    bn as WebGLCoordinateSystem,
    b as WebGLCubeRenderTarget,
    I as WebGLRenderTarget,
    ca as WebGLRenderer,
    na as WebGLUtils,
    vn as WebXRController,
    Ge as ZeroFactor,
    Sn as createCanvasElement,
};
